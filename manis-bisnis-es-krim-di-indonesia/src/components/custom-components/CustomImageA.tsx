  ...
  >
    <div className="max-w-4xl mx-auto w-full relative px-4 sm:px-6 md:px-8 lg:px-0">
      ...
      >
        ...
        <motion.p
          className="text-sm sm:text-base md:text-lg !leading-relaxed md:!leading-loose"
          initial={{ opacity: 0, y: 15 }}
          animate={titleInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 15 }}
      ...
      >
        ...
        >
          <motion.div
            className="bg-white rounded-xl sm:rounded-2xl md:rounded-[2rem] shadow-2xl p-3 sm:p-4 md:p-6 lg:p-8 z-10 relative"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={infoBoxInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.95 }}
            transition={{ duration: 0.8, delay: 1, ease: "easeOut" }}
          >
            <motion.div
              className="text-[#ad1618] font-bold text-base sm:text-lg md:text-xl lg:text-2xl text-center mb-4 sm:mb-16 md:mb-[6rem]"
