  ...
  return (
    <section>
      <div className="relative w-full">
        ...
        <div className="absolute bg-gradient-to-b from-black/10 to-[#FAFAFA] z-0 left-0 right-0 top-0 bottom-0"></div>
        <motion.h2
          initial={{ opacity: 0 }}
      ...
      <div className="relative flex items-center justify-center h-[1300px]">
        <motion.img initial={{ opacity: 0, y: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} src={`${baseUrl}/assets/11.1.png`} alt="Background" className="absolute" />
