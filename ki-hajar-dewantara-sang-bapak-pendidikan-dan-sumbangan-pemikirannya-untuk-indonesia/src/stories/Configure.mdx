...
<Meta title="GNFI Insight Components" />

<div className="sb-container">
  <div className='sb-section-title'>
    # GNFI Insight Components

    Kumpulan komponen untuk artikel GNFI Insight. Akan selalu di update dan ditambahkan komponen dengan barbagai varian baru
  </div>
