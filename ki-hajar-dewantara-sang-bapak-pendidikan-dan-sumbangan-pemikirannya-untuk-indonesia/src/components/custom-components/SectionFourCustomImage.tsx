  ...
  return (
    <section>
      <div className="relative flex flex-col items-center">
        ...
        <motion.img initial={{ opacity: 0, x: -20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x1: 0 }} transition={{ delay: 2.2 }} src={`${baseUrl}/assets/student.png`} alt="quote" className="absolute top-0" />
        <motion.img initial={{ opacity: 0, x: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 2.4 }} src={`${baseUrl}/assets/student-toga.png`} alt="quote" className="absolute top-0" />
        <motion.img initial={{ opacity: 0, x: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 2.6 }} src={`${baseUrl}/assets/student-jacket.png`} alt="quote" className="absolute top-0" />
        <motion.img initial={{ opacity: 0, x: -20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 2.8 }} src={`${baseUrl}/assets/student-jilbab.png`} alt="quote" className="absolute top-0" />
        <motion.img initial={{ opacity: 0, y: -20 }} viewport={{ once: false }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 2.1 }} src={`${baseUrl}/assets/students.png`} alt="quote" className="absolute top-0" />
