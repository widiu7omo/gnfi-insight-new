        ...
        <div className="flex justify-center flex-col max-w-4xl mx-auto relative lg:mt-[27rem]">
          ...
          <div className="absolute top-[5%] sm:top-[13%] max-w-full sm:max-w-[75%] mx-auto space-y-4 z-10">
            <motion.h4
              ...
              className="pt-[43%] sm:pt-0 pl-4 pr-4 sm:pr-0 sm:pl-[30%] text-3xl sm:text-5xl xl:text-6xl font-extrabold">
              Kedekatan
              Silas Papare
            ...
            <motion.p
              ...
              className="text-base sm:text-xl pl-4 pr-4 sm:pr-0 sm:pl-[30%]">
