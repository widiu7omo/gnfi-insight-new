...
export function SectionFiveCustomImage() {
  return (
    <section
      className="relative flex flex-col items-center bg-cover bg-top bg-no-repeat"
    ...
    >
      ...
      <div className="flex items-center justify-center absolute bottom-0 w-full">
        ...
        <motion.img
          ...
          alt="elipse-atas"
          className="absolute w-full bottom-0 left-0 right-0 z-10 max-w-4xl mx-auto"
        />
      </div>
    </section>
  );
