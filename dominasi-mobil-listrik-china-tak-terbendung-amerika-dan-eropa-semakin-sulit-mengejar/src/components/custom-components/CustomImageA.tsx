        ...
        <div className="flex flex-col md:flex-row flex-wrap">
          <div className="relative basis-1/2 p-2">
            <motion.img
              ...
              src={baseUrl + '/assets/1.2.png'} alt="Capres" className="absolute top-[-7rem] w-[10rem] left-[16px]" />
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="relative basis-1/2 p-2">
            <motion.img
              ...
              src={baseUrl + '/assets/1.3.png'} alt="Money" className="absolute top-[-3rem] h-[8rem] lg:h-[10rem] right-0 z-10" />
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.1, duration: 0.6 }}
              className="bg-[#352925] p-4 xl:p-6 rounded-xl relative pr-[5rem]">
          ...
          <div className="relative basis-1/2 p-2">
            <motion.img
              ...
              src={baseUrl + '/assets/1.4.png'} alt="Rocket" className="absolute top-[-2rem] w-[5rem] lg:w-[8rem] right-8 lg:right-0 z-10" />
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="relative basis-1/2 p-2 mt-0 md:-mt-6 lg:-mt-8 2xl:-mt-18">
            <motion.img
              ...
              src={baseUrl + '/assets/1.5.png'} alt="Arrow" className="absolute top-0 bottom-0 lg:bottom-0 lg:top-[-3rem] w-[6rem] lg:w-[10rem] right-0 lg:right-[-3rem] z-10" />
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="bg-[#4f2911] pt-16">
        <div className="flex flex-col max-w-4xl mx-auto relative px-6 pb-10">
          <motion.div
            ...
            transition={{ delay: 0, duration: 0.6 }}
            className="absolute px-8 left-0 md:left-[8px] shadow-lg py-4 -top-[6rem] text-2xl font-bold text-white rounded-r-full bg-[#8e4c1f]">Beberapa Polemik MBG</motion.div>
