      ...
      <div className="relative z-10 pt-[3rem] xl:pt-[5rem]">
        <div className="max-w-4xl mx-auto ">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="px-4 lg:px-0 text-2xl md:text-3xl xl:text-4xl font-bold font-sora py-2">Dominasi Pasar dan Trajektori Pertumbuhan</motion.p>
          <motion.p
            initial={{ opacity: 0, y: -20 }} whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: .5, delay: .4 }}
            viewport={{ once: true }}
            className="px-4 lg:px-0 py-8 text-lg md:text-xl xl:text-2xl font-sora xl:max-w-[80%]">China telah melesat menjadi pemimpin global yang tak terbantahkan di industri kendaraan listrik</motion.p>
          <div className="w-full relative flex flex-row-reverse">
            ...
            <motion.img
              ...
              src={`${baseUrl}/assets/1.1.png`} className="h-full w-[70%] md:w-[60%] ml-auto z-10 relative" />
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0 }}
        ...
        <div className="relative flex items-center justify-center z-0 xl:z-0">
          <motion.img
            ...
            whileInView={{ opacity: 1 }}
            transition={{ delay: 0, duration: 0.6 }}
            src={`${baseUrl}/assets/1.0.png`} className="bottom-0 max-w-4xl -mt-[20rem] xs:-mt-[25rem] sm:-mt-[30rem] xl:-mt-[40rem] h-full w-full mx-auto relative z-10" />
          <motion.img
            viewport={{ once: true }}
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ delay: 0.3, duration: 0.6 }}
            src={`${baseUrl}/assets/1.0.png`} className="bottom-[-5rem] scale-[1.3] mx-auto absolute z-0 blur-3xl" />
