...
export function CustomImageC() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        <div className="absolute left-0 top-0 h-[30%] w-full bg-gradient-to-b from-[#FAFAFA]" />
            ...
            <div className="rounded-3xl border border-white bg-[#043F6A]">
              <div className="flex flex-col md:flex-row">
                <motion.img
                  ...
                  alt="Mobil Abu"
                  className="z-20 h-auto w-[100%] md:-mr-12 md:-mt-12 md:w-[48%] md:pr-4"
                />
                <motion.p
            ...
            <div className="flex w-full flex-col items-center justify-center gap-16 px-8 pb-8 pt-8 md:flex-row md:px-24">
              <div className="flex w-full flex-col md:w-1/2">
                <motion.img
                  ...
                  alt="Mobil Peta 1"
                  className="z-20 mx-auto h-auto w-[100%] pb-4 md:w-[60%]"
                />
                <motion.p
                  {...fadeInUp(0.1)}
                ...
                <motion.div
                  className="mx-auto h-[1px] w-[80%] origin-left bg-[#CEBFB1] md:mx-0"
                  initial={{ scaleX: 0 }}
