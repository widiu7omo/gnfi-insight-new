...
export function CustomImageB() {
  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden ">
      <div
        className="relative flex h-full w-full justify-center bg-cover bg-[center_top_55%] text-center pt-10 xl:pt-32"
        style={{ backgroundImage: `url(${baseUrl}/assets/2.0.jpg)` }}
      >
        <div className="absolute w-full h-[50%] bg-gradient-to-b from-[#011625] top-0" />
        <div className="absolute w-full h-[50%] bg-gradient-to-t from-black bottom-0" />
        <div className="z-10 w-full">
          <div className="max-w-4xl mx-auto relative space-y-2 inset-x-0 z-10 mb-4 text-left font-sora text-3xl font-bold text-[#ffe354] md:text-6xl flex flex-col justify-center items-center">
            <motion.h4
              ...
              className="py-2 rounded-xl break-words w-fit !leading-tight px-4 md:px-6 xl:px-0 text-4xl md:text-5xl xl:text-6xl">
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center max-w-4xl mx-auto relative">
            <div className="flex-1 font-sora text-lg text-left text-white space-y-4 px-4 md:px-6 xl:px-0">
              <div>Kesuksesan luar biasa industri EV China tak lepas dari dukungan pemerintah yang besar dan konsisten</div>
              <div>Beijing telah menggelontorkan dana sekitar <span className="text-[#ffe354] font-bold">US$230</span> miliar untuk sektor ini antara 2009 dan 2023.</div>
            </div>
            <div className="flex-1 pr-4 -mb-[2rem]">
              <img src={`${baseUrl}/assets/2.1.png`} alt="Presiden Cina" />
            </div>
          </div>
          <div className="max-w-4xl mx-auto relative scale-125 xs:scale-100">
            <img src={`${baseUrl}/assets/2.2.png`} alt="Stats" className="-ml-[1rem] xs:ml-0" />
          </div>
          <div className="h-[40rem] md:h-[20rem]"></div>
          <div className="flex flex-col sm:flex-row max-w-4xl mx-auto relative items-end space-y-6 sm:space-y-0">
            ...
            <div className="flex-1 px-4 md:px-12">
              <img src={`${baseUrl}/assets/2.3.png`} alt="Factory" className="w-full" />
