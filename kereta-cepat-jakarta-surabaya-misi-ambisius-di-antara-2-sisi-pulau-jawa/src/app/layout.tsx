...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <Script defer id="foundation-widget" type="module" src="https://gnfifoundation.org/assets/widget/widget.js?v=11" crossOrigin="anonymous" widget-container="donation-container" />
      <Script
