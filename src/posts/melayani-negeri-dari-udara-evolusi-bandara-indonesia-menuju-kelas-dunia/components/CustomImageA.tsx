    ...
    <div className="relative flex flex-col items-center overflow-hidden bg-[#bec6c9]">
      <div className="relative w-full pt-16 pb-10 md:pt-24 md:pb-28">
        <div className="mx-auto max-w-4xl px-6 md:px-8 lg:px-0">
          <motion.h2
            className="mb-6 font-sora text-[28px] font-bold text-[#3b3a3c] leading-tight md:mb-12 md:text-[54px] md:leading-14"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
        ...
        >
          <div className="z-0 flex w-full flex-1 flex-col">
            <motion.p
              className="mb-4 font-sora text-xl font-semibold leading-[1.4] text-[#3b3a3c] md:mb-6 md:text-[34px] md:leading-10"
              variants={fadeUp}
            >
            ...
            <motion.p
              className="mt-4 font-sora text-lg font-semibold leading-[1.6] text-[#3b3a3c] md:text-2xl md:leading-10"
              variants={fadeUp}
            >
          ...
          <motion.div className="flex w-full flex-1 justify-center md:justify-end" variants={fadeUp}>
            <motion.img
              src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.1.png`}
              alt="Landing Plane"
      ...
      <div className="relative w-full rounded-t-full bg-[#37586e] pb-10 pt-0 md:rounded-t-[16rem] md:pb-24">
        <div className="mx-auto max-w-4xl px-6 pb-12 pt-12 md:px-8 lg:px-0">
          <div className="rounded-[3rem] bg-[#ffc637] px-4 py-10 sm:px-8 md:rounded-[4rem] md:px-12">
            <motion.div
              className="relative flex flex-col gap-6 rounded-3xl bg-[#ed514c] p-6 sm:p-8 md:flex-row md:items-center md:gap-12 md:p-10 lg:pl-52"
              variants={staggered}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
            >
              <motion.img
                src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.2.png`}
                alt="Serat Centhini"
        ...
        <div className="mx-auto max-w-4xl px-6 md:px-8 lg:px-0">
          ...
          <div className="relative">
            <img src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.5.png`} alt="Map IDN" className="mt-24 opacity-60" />
            <img src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.6.png`} alt="Pin Letung" className="absolute inset-0" />
            <img src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.7.png`} alt="Pin Miangas" className="absolute inset-0" />
            <img src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.8.png`} alt="Pin Koroway" className="absolute inset-0" />
          ...
          <div className="relative font-sora py-12">
            ...
            >
              <motion.li className="flex items-center gap-4 rounded-2xl bg-white/10 p-4" variants={fadeUp}>
                <img src={"/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/1.4.png"} alt="Ikon Bandara" className="h-12 w-12" />
                <div>
