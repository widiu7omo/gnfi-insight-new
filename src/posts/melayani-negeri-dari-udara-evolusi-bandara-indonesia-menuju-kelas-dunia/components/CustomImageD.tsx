  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div className="bg-[#1C5396] w-full pt-20 pb-6 md:pt-24 md:pb-8 relative">
        <div className="relative mx-auto max-w-4xl lg:px-0 md:px-8 px-4 mb-96 md:mb-32">
          <div className="relative">
            <div className="w-full relative z-10">
              <motion.h2
                className="font-sora text-[#FFC637] font-bold w-full text-[32px] md:text-8xl md:leading-26"
              ...
              <motion.p
                className="mt-2 md:mt-6 font-sora text-white w-full md:w-[70%] text-xl md:text-[28px] md:leading-10"
        ...
        <div className="relative w-full">
          <motion.img
            src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/4.1.png`}
            alt="Airport"
          ...
          />
          <motion.div
            className="absolute md:mt-0 -mt-80 inset-0 lg:px-0 md:px-8 px-4 flex md:flex-row flex-col mx-auto max-w-4xl md:space-x-8 md:space-y-12 space-y-4"
          ...
          >
            <motion.div
              className="bg-linear-to-b from-[#EC514C] via-[#EC514C]/70 to-transparent px-5 pt-4 w-full md:w-1/3"
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <div className="absolute inset-y-0 left-0 w-1 bg-linear-to-b from-[#EC514C] to-transparent"></div>
      ...
      <div className="bg-[#EC514C] w-full pt-20 pb-6 md:pt-24 md:pb-8 relative">
        <div className="relative w-full">
          <motion.img
            src={`/assets/melayani-negeri-dari-udara-evolusi-bandara-indonesia-menuju-kelas-dunia/4.2.png`}
            alt="Airport"
