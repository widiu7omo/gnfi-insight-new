...
export function QuoteS4() {
    return <div>
        <div className={cn("w-full h-full max-w-[65ch] mx-auto bg-cover px-4 lg:px-0 relative overflow-clip")}>
            <div className="flex items-center justify-center relative z-10">
                <motion.img
                    ...
                    viewport={{ once: true }}
                    src={`/assets/shin-tae-yong-dan-tangan-dinginnya-yang-mengubah-timnas-indonesia/3.2.png`}
                    alt={"unknown"}
                    className={cn("w-full")}
                />
            </div>
