...
export function CustomImageE() {
  ...
  return (
    <motion.div
      className="relative flex flex-col items-center overflow-hidden font-sora bg-no-repeat bg-position-[center_top_20%] bg-cover" style={{ backgroundImage: `url('/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/5.3.png')` }}
    >
      ...
      {/* <div className="z-30 absolute inset-0 flex items-center justify-center">
        <img src={'/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/5.1.png'} alt="Traditional Activity" className="object-cover " />
      </div> */}
      <div className="py-8 lg:py-20 bg-linear-to-b from-white to-white/70 backdrop-blur-3xl w-full rounded-br-[8rem] z-20">
        <motion.div
          ref={heroRef}
        ...
        >
          <div className="space-y-4 px-4 lg:px-0 ">
            ...
            <motion.p
              ...
              className="text-lg lg:text-2xl w-[80%] text-black">
      ...
      <div className="w-full">
        <div className="w-full relative">
          <img src={'/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/5.2.png'} alt="Batik" className="object-cover w-full absolute inset-0 z-10 -mt-[20%]" />
          <div className="max-w-4xl mx-auto flex flex-col-reverse lg:flex-row relative h-fit -mt-[6rem] lg:mt-0 lg:pt-[10rem] pb-[4rem] lg:pb-[15rem] z-20">
            ...
            <motion.img
              ...
              src={'/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/5.6.png'} alt="Traditional" className="lg:absolute z-20 right-0 lg:right-[-15rem] top-[-5rem] lg:top-[-15rem] scale-[.8]" />
          </div>
        </div>
        <div className="">
          <motion.div
          ...
          >
            <div className="max-w-4xl px-0 pt-10 pb-6 sm:pb-24 mx-auto text-white text-base sm:text-lg lg:text-2xl leading-relaxed relative flex flex-col lg:flex-row lg:items-end">
              <motion.div
                ...
                <img src={'/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/5.4.1.png'} alt="I Made Dharma Suteja" className="object-cover relative z-10" />
