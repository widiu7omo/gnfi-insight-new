  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#3E3632] text-white font-sora">
      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-16 pb-10">
        ...
        <div className="absolute top-0 -left-16 w-[80%] md:w-[60%] lg:w-[50%] z-0 pointer-events-none">
          <motion.img
            initial={{ scale: 0.8, opacity: 0, x: 20 }}
            whileInView={{ scale: 1, opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
            src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/1b.1.png`}
            alt="Dancers Left"
        ...
        <div className="absolute top-[40%] right-0 xl:right-40 w-[30%] md:w-[25%] z-20 pointer-events-none translate-x-1/4">
          <motion.img
            initial={{ scale: 0.8, opacity: 0, x: 20 }}
            whileInView={{ scale: 1, opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
            src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/1b.2.png`}
            alt="Bowl Decoration"
        ...
        <div className="relative z-10 max-w-4xl mx-auto xl:px-32">
          ...
          >
            {steps.map((step, i) => (
              ...
              >
                <div className="shrink-0 w-14 md:w-20 flex items-center justify-center text-3xl md:text-5xl font-bold text-[#E8DCCF]">
                  {step.id}
                </div>
      ...
      <div className="relative w-full flex justify-center py-10 z-10 bg-[#3E3632]">
        <motion.img
          src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/1b.3.png`}
      ...
      <div className="relative w-full mt-10 pb-6">
        ...
        <div className="relative w-full flex items-center justify-center overflow-hidden">
          <motion.img
            ...
            whileInView={{ scale: 1, opacity: 1 }}
            transition={{ duration: 0.6 }}
            src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/1b.4.png`}
            alt="Dancers Bottom Background"
            className=" inset-0 w-full h-full object-cover object-top brightness-75 max-w-7xl mx-auto"
          />
          <div className="absolute z-10 max-w-4xl px-6 text-center bottom-40">
            <motion.div
              initial={{ scale: 0.8, opacity: 0 }}
              whileInView={{ scale: 1, opacity: 1 }}
              transition={{ duration: 0.6 }}
