    ...
    <div className="relative w-full bg-white pb-8 xl:pb-28 font-sora">
      ...
      <div className="relative h-[900px] w-full overflow-hidden bg-[#7a00cc]">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/1a.1.1.jpg')`,
          ...
          {cards.map((card, index) => (
            ...
            >
              <div
                ...
                style={{ backgroundImage: `url('/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/${card.image}')` }}
              />
