...
export function CustomImageC() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div className="absolute h-40 bg-linear-to-b from-[#f6f0fa] z-20 w-full inset-x-0 top-0"></div>
      <div className="absolute h-40 bg-linear-to-t from-[#d9dcf2] z-40 w-full inset-x-0 bottom-0"></div>
      <div
        className="relative w-full justify-center bg-cover bg-center pt-16 md:pt-24"
        style={{ backgroundImage: `url(/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.8.png)` }}
      >
        ...
        <div className="relative mx-auto max-w-4xl">
            ...
            <div className="relative w-full md:w-1/2 pb-[50%] lg:pb-[36%]">
              <div className="relative md:pb-4 z-20">
                <div className="relative overflow-hidden">
                  <motion.img
                    src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.1.png`}
                    alt="reog ponorogo"
                ...
                <div className="absolute -top-[60%] -right-10 md:-right-20 w-[60%] md:w-[70%] z-10">
                  <motion.img
                    src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.2.png`}
                    alt="penari"
                    className="w-full"
                    initial={{ opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                <div className="absolute -bottom-9 -left-20 w-[75%] md:w-[85%]">
                  <motion.img
                    src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.5.png`}
                    alt="penari"
                    className=""
                ...
                <motion.img
                  src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.3.png`}
                  alt="Silat"
          ...
          <div className="">
            <motion.img
              src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.4.png`}
              alt="Silat"
            ...
            />
            <motion.img
              src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.9.png`}
              alt="Jamu"
            ...
            />
            <motion.img
              src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.6.png`}
              alt="Orang"
            ...
            />
            <motion.img
              src={`/assets/menjaga-warisan-budaya-takbenda-melestarikan-kekayaan-indonesia/3.7.png`}
              alt="Gamelan"
