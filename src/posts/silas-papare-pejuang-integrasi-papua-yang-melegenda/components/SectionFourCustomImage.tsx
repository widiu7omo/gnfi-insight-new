...
export function SectionFourCustomImage() {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: `url('/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/4.5.png')` }}
    >
      <img src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/4.0.png`} className="absolute top-0 left-0 w-full" alt="Background" />
      <div className="flex flex-col sm:flex-row mx-auto max-w-4xl pt-[340px] max-sm:-mt-40 2xl:pt-[480px]">
        ...
        >
          ...
          <motion.ul
            className="px-5 text-lg lg:text-2xl text-black space-y-5 w-full lg:w-3/4 pl-4"
            style={{ listStyleImage: `url('/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/list.png')` }}
            variants={staggerChildren}
          >
          ...
          <motion.img
            src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/4.2.png`}
            variants={fadeIn}
        ...
        <div className="bg-[#0C6958] text-white -mt-20 xl:mt-0 flex-1 overflow-clip sm:overflow-visible">
          <motion.img
            ...
            src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/4.4.png`}
