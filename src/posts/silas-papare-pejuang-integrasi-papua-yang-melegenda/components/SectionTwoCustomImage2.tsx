  ...
  return (
    <section id="section-1" className="bg-[#c1bbb5] -mt-1 overflow-clip ">
      <div className="relative flex items-start justify-center overflow-clip flex-col">
        <div
          className="w-full bg-cover bg-no-repeat bg-position-[center_top] relative"
          style={{ backgroundImage: `url('/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.0.jpeg')` }}
        >
          <div className="max-w-4xl mx-auto relative z-10 mt-60">
            <div className="space-y-0">
              <div className="relative flex items-center justify-center z-0">
                <motion.img
                  ...
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.2.png`}
                  alt="Paper Torn"
                ...
                <motion.img
                  ...
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.2-sm.png`}
                  alt="Paper Torn"
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.3, duration: 0.5 }}
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.1.png`}
                ...
                <div className="absolute left-[15%] sm:left-[10%] top-[15%] sm:top-[20%] max-w-[75%] sm:max-w-[50%] space-y-1 sm:space-y-4 xl:space-y-8">
                  <motion.p
                    ...
                    <br />
                    <span className="text-black">Silas Papare</span>
                  </motion.p>
                  <motion.ul className="list-disc text-black marker:text-red-600 text-base xl:text-lg space-y-1 sm:space-y-2 xl:space-y-4">
                    <motion.li
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-linear-to-b from-90% from-transparent to-[#c1bbb5]" />
        </div>
        <div
          className="w-full bg-cover bg-no-repeat bg-position-[center_top] xl:bg-center relative"
          style={{ backgroundImage: `url('/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.4.png')` }}
        >
          <div className="absolute top-0 left-0 w-full h-full bg-linear-to-b to-80% to-transparent from-[#c1bbb5]" />
          <div className="max-w-4xl mx-auto relative z-10 mb-20 mt-20 sm:mt-0">
            <div className="space-y-0">
              <div className="relative flex items-center justify-center z-0">
                <motion.img
                  initial={{ opacity: 0, x: 20 }}
                  ...
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.5.png`}
                  alt="Paper Torn"
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.35, duration: 0.5 }}
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.5-sm.png`}
                  alt="Paper Torn"
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  transition={{ delay: 0.3, duration: 0.5 }}
                  src={`/assets/silas-papare-pejuang-integrasi-papua-yang-melegenda/2.3.png`}
                  alt="Silas Papare Top"
                ...
                <div className="absolute top-[10%] left-[15%] px-0 sm:px-14 max-w-[70%] sm:max-w-[50%] sm:ml-auto z-10 right-0">
                  <ul className="list-disc text-black marker:text-red-600 text-base xl:text-lg space-y-1 sm:space-y-2 xl:space-y-4">
                    <motion.li
                      initial={{ opacity: 0, x: 10 }}
                      viewport={{ once: true }}
                      whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-linear-to-b from-80% from-transparent to-[#f3f1e9]" />
        </div>
      </div>
    </section>
  );
