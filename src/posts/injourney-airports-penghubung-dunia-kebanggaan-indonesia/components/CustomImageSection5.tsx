    ...
    <div className="relative flex flex-col items-center overflow-hidden bg-cover font-sora bg-[#e5e9ec]">
      <div className="relative w-full">
        <motion.img
          ...
          src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/5.1.png`}
          alt="Airport"
          className="z-0 object-cover w-full h-full 2xl:h-240! object-center pb-24 xs:pb-12 sm:pb-12 2xl:pb-0"
        />
        <div className="absolute inset-0 z-10 bg-linear-to-b h-[30%] from-[#f9f9fa]" />
        <div className="absolute bottom-0 z-10 flex justify-start w-full transform pb-4 sm:pb-18 lg:pb-4 2xl:pb-12">
      ...
      <div className="relative flex w-full items-center justify-center bg-linear-to-r from-[#0b8d98] to-[#0b8d98] pt-4 md:pt-20">
        <div className="relative flex flex-col sm:flex-row justify-between w-full px-4 mx-8 sm:mx-4 2xl:mx-auto md:max-w-4xl md:space-x-4 md:px-10">
          <div className="relative z-40 2xl:w-1/2 w-full xs:w-[70%] sm:w-full my-auto text-white space-y-4 md:mb-48 md:max-w-md">
            <div className="text-base sm:text-xl font-semibold leading-relaxed text-left md:text-lg">
              <motion.img
                ...
                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/quote.png`} alt="Quote Start" className="size-8 absolute top-[-2%] -left-12" />
              <motion.p
                viewport={{ once: true }}
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1 }}
                transition={{ delay: 0.6, duration: 0.5 }}
                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/quote.png`} alt="Quote End" className="size-8 rotate-180 absolute bottom-20 right-[-10%]" />
            </div>
            <motion.div
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -10 }}
          ...
          <div className="w-full overflow-hidden md:w-1/2 pt-16 xs:pt-8 sm:pt-0 z-50 xs:z-0">
            <div className="absolute bottom-0 z-20 h-auto w-[50%] sm:w-[53%] -right-8 md:right-0 overflow-hidden object-cover md:max-w-7xl">
              <motion.img
                initial={{ opacity: 0, y: '100%' }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 1.6, ease: "anticipate", delay: .3 }}
                viewport={{ once: true }}
                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/5.2.png`}
                alt="Pgs. Corporate"
                className="relative bottom-0"
              />
              <div className="absolute h-[40%] w-full bottom-0 bg-linear-to-t from-[#0b8d98]" />
            </div>
          </div>
        </div>
      </div>
      <div className="relative flex flex-col items-center justify-center w-full bg-bottom overflow-hidden" style={{ backgroundImage: `url(/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/5.4.png)` }}>
        <div className="h-[40%] bg-linear-to-b from-[#0b8d98] to-black/0 from-30% absolute top-0 w-full z-10" />
        <div className="absolute top-[-15%] z-0 max-w-7xl mx-auto">
          <div className="relative">
            <motion.img
              ...
              whileInView={{ opacity: 1, x: 0, y: 0 }}
              transition={{ delay: 0.3, duration: 0.4 }}
              src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/5.3.png`}
              alt="Hand"
              className=" h-auto w-full object-cover"
            />
          </div>
        </div>
        <div className="inset-0 z-30 flex items-center justify-center px-4 pb-40">
          <div className="flex flex-col w-full space-y-12 md:max-w-4xl md:px-10 lg:space-y-16">
            <motion.p
              viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="items-stretch min-h-full grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-16 pt-40 ">
              <motion.div
                viewport={{ once: true }}
      ...
      <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/footer.png`} alt="Footer" className="max-w-7xl mx-auto absolute bottom-0 z-20 w-full" />
    </div>
  );
}
