...
export function CustomImageSection3() {
  ...
  return (
    <div
      ...
      ref={ref} style={{ backgroundImage: `url("/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/3.3.png")` }}
    >
      <div className="bg-linear-to-b from-[#ccf2fb] w-full h-[300px] absolute z-10" />
      <div className="relative w-full">
        <div className="relative inset-0 z-10">
          <div className="w-full mx-auto lg:max-w-4xl md:px-0 lg:px-10">
            <div className="flex flex-col items-center px-4">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="md:px-15 text-left text-2xl xs:text-4xl sm:text-5xl xl:text-[58px] font-sora font-extrabold text-[#042d73] md:mt-6 "
              >
                Menatap Masa Depan
              </motion.p>
            </div>
            <div className="relative z-10 flex justify-end w-full">
              <div className="relative md:absolute z-20 md:left-0 lg:left-2 w-full md:w-1/2 mt-80 md:mt-4 mx-4 flex justify-center">
              ...
              <motion.img
                ...
                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/3.1.png`}
                alt="People"
                className="absolute top-0 md:relative h-full w-full md:w-1/2 right-0 object-contain object-top md:max-w-4xl mt-0 md:mt-20 lg:mt-0"
              />
              <motion.img
                viewport={{ once: true }}
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ delay: 0.3, duration: 0.4 }}
                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/3.1.1.png`}
          ...
          <motion.img
            ...
            whileInView={{ opacity: 1 }}
            transition={{ delay: 0.3, duration: 0.4 }}
            src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/3.2.png`}
            alt="People"
            className="h-full w-full bottom-[-50%] right-0 object-cover relative z-20 mt-0 md:-mt-20 lg:mt-0"
          />
        </div>
      </div>
      <div className="relative z-50 w-full pt-10 pb-12 bg-white">
        ...
        <div className="absolute bottom-0 right-0 flex justify-end w-full">
          <motion.img
            ...
            transition={{ delay: 0.3, duration: 0.4 }}
            src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/3.5.png`}
            alt="Airport"
