import { BoxReveal } from "@/components/post/box-reveal";
...
export function CustomHeroSection0() {
    return (
        <div
            ...
            style={{
                background: `url("/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/0.1.jpg")`,
            }}
        >
            <motion.div
                viewport={{ once: true }}
                ...
                className={cn("absolute h-full w-full bg-linear-to-tr from-black/80")}>
                <div className="flex flex-col justify-between h-full px-4 py-8 mx-auto max-w-7xl xl:px-0">
                    <div className="flex items-center justify-center flex-1 w-full xl:items-end xl:justify-start ">
                        ...
                        >
                            <motion.img
                                ...
                                src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/0.2.png`} alt="Gnfi Insight" className="absolute top-[-13%] hidden sm:block h-8 xl:h-auto" />
                    ...
                    <div className="flex items-center justify-center">
                        <div className="animate-[bounce_2s_ease_infinite]">
                            <svg className="size-10 animate-[spin_9s_linear_infinite]" viewBox="0 0 57 57" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Logo" role="img">
