        ...
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-col items-center w-full lg:flex-row">
            <motion.div
              ...
              transition={{ duration: .8, ease: "easeInOut" }}
              viewport={{ once: true }}
              className="md:w-1/2 lg:w-1/2 xl:w-1/3 sm:max-w-[68%] lg:max-w-full text-white bg-[#064038] p-6 pb-10 lg:p-10 rounded-xl space-y-6 h-fit relative mx-4 lg:mx-0 lg:left-36">
              <p
              ...
              <ul className="space-y-4">
                <li className="flex items-start space-x-6">
                  <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.2.png`} alt="" className="size-[35px] pt-1" />
                  <div className="text-lg font-sora lg:text-xl">Peningkatan kualitas infrastruktur bandara</div>
                </li>
                <li className="flex items-start space-x-6">
                  <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.3.png`} alt="" className="size-[35px] pt-1" />
                  <div className="text-lg font-sora lg:text-xl">Manajemen operasional berbasis ekosistem</div>
                </li>
                <li className="flex items-start space-x-6">
                  <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.4.png`} alt="" className="size-[35px] pt-1" />
            ...
            <div className="lg:w-3/4 -mt-10 xl:mt-0 z-10 lg:z-[-1]">
              <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.1.svg`} className="w-full" alt="Airport" />
            </div>
          </div>
        </div>
      </div>
      <div className="relative w-full overflow-hidden">
        <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.0.jpg`} alt="Background Airport" className="absolute bottom-0 w-full" />
        <div className="absolute bottom-0 top-0 sm:top-16 md:top-0 w-full bg-linear-to-b from-[#eee9dd] to-80% h-full" />
            ...
            <div className="space-y-10">
              <motion.div
                ...
                <div className="relative w-full md:w-[350px]">
                  <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.6.png`} alt="How 1" className="object-cover w-full" />
              ...
              <motion.div
                ...
                <div className="relative w-full md:w-[350px]">
                  <img src={`/assets/injourney-airports-penghubung-dunia-kebanggaan-indonesia/2.7.png`} alt="How 2" className="object-cover w-full" />
