...
export function CustomImageA() {
  return (<div className="relative overflow-clip">
    ...
    <motion.div
      className="rounded-l-[20rem] h-200 w-[50vw] absolute top-0 right-[-0%] bottom-0 bg-linear-to-br to-80% from-yellow-500 to-red-500"
      initial={{ opacity: 0, x: 100 }}
      animate={{ opacity: 1, x: 0 }}
      transition={{ duration: 1.2, ease: "easeOut" }}
    ></motion.div>
    <motion.div
      className="rounded-l-[20rem] h-200 w-[70vw] absolute top-[40%] blur-2xl right-[-10%] bottom-0 bg-linear-to-br from-red-500 to-pink-500"
    ...
    >
      <div className="max-w-4xl mx-auto font-sora">
        <div className="flex gap-2 flex-col md:flex-row items-center justify-between gap-4">
          ...
          >
            <motion.img
              ...
              src={'/assets/pp-tunas-upaya-melindungi-anak-anak-indonesia-di-dunia-digital/1.1.png'}
              alt="Prabowo"
              whileHover={{ scale: 1.05 }}
        ...
        >
          <motion.div
            className="absolute left-11 top-11 bottom-11 right-11 bg-linear-to-r from-blue-800 to-blue-600 transform -skew-y-1 scale-110"
            initial={{ opacity: 0, scale: 0.8, rotate: -2 }}
            animate={{ opacity: 1, scale: 1.1, rotate: -1 }}
            transition={{ duration: 0.8, delay: 0.6, ease: "easeOut" }}
          ></motion.div>
          <motion.div
            className="absolute left-12 top-12 bottom-12 right-12 bg-linear-to-r from-blue-600 to-blue-400 transform skew-y-1 scale-110"
            initial={{ opacity: 0, scale: 0.8, rotate: 2 }}
            animate={{ opacity: 1, scale: 1.1, rotate: 1 }}
        ...
        <motion.div className="space-y-8" variants={itemVariants}>
          <motion.div
            className="text-center text-2xl md:text-4xl font-bold pt-6 md:pt-12 text-black"
            variants={itemVariants}
          >
          ...
          >
            <motion.div className="flex-1" variants={cardVariants}>
              <motion.div
                className="bg-white text-black rounded-2xl shadow-lg px-10 md:px-12 py-8 m-4 md:m-0 transition-all duration-300 hover:shadow-xl"
        ...
        >
          <motion.img
            src={"/assets/pp-tunas-upaya-melindungi-anak-anak-indonesia-di-dunia-digital/1.2.png"}
            alt="3d Childs"
