...
export function SectionHeaderS5() {
    return (
        <>
            {/* Header */}
            <div
                className={cn("flex h-full relative flex-col items-center justify-start bg-cover bg-no-repeat bg-position-[center_top_20%]",
                )}
                style={{
                    backgroundImage: `linear-gradient(to top, #2A201B,rgb(208, 184, 229,0.0)),linear-gradient(0deg, rgb(208, 184, 229,0.0) 0%, rgba(122, 187, 202, 1) 100%),url('/assets/cerita-dari-megahnya-masjid-istiqlal/5.1.png')`,
                }}
            >
                <motion.img
                    ...
                    viewport={{ once: true }}
                    src={`/assets/cerita-dari-megahnya-masjid-istiqlal/5.2.png`} />
                <div className="relative flex md:flex-row flex-col space-y-4 md:space-y-0 space-x-0 md:space-x-4 justify-end md:justify-center items-center md:items-end h-[800px] w-full overflow-clip">
                    <motion.img
                        ...
                        src={`/assets/cerita-dari-megahnya-masjid-istiqlal/5.3.png`} />
                    <motion.img
                        initial={{ x: 20, opacity: 0 }}
                        ...
                        viewport={{ once: true }}
                        className="overflow-hidden size-[400px] object-cover"
                        src={`/assets/cerita-dari-megahnya-masjid-istiqlal/5.4.png`} />
                </div>
                {/* Paragraph */}
                ...
                <Image imageUrl="/assets/cerita-dari-megahnya-masjid-istiqlal/5.5.png"
