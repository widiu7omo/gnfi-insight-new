...
export function SectionOneComponent() {
    return <>
        <Hero coverUrl="/assets/cerita-dari-megahnya-masjid-istiqlal/cover-1.webp"
            title={<motion.h1
                viewport={{ once: true }}
                initial={{ opacity: 0, y: 0 }}
                whileInView={{ opacity: 1, y: -20 }}
                className="max-w-full xl:max-w-[80%] font-serif text-center text-4xl font-bold leading-snug! text-white lg:text-5xl xl:text-7xl"
            ...
            gradientColor="bg-linear-to-t from-[rgb(254_220_96/1)] from-0% to-60%"
        />
        <section className="relative flex items-center justify-center flex-col min-h-screen space-y-6 sm:space-y-10 bg-custom-yellow! pb-20 pt-80 text-black lg:px-20 overflow-hidden">
            ...
            <ImageAnimation start="right">
                <img
                    src={`/assets/cerita-dari-megahnya-masjid-istiqlal/pahlawan.png`}
                    alt=""
                    width={1080}
                    height={893}
            ...
            <ul className="space-y-12 sm:space-y-20 max-w-4xl w-full">
                ...
                <ImageAnimation start="right" className="">
                    <div className="relative flex flex-col items-start justify-center">
                        <div className="absolute sm:bg-linear-to-tr bg-linear-to-r xl:bg-linear-to-tr from-20% to-60% from-black to-white/0 h-full flex items-end">
                        ...
                        <img
                            src={`/assets/cerita-dari-megahnya-masjid-istiqlal/doc-2.png`}
                            alt=""
                            width={750}
                            height={512}
                ...
                <ImageAnimation start="right" className="">
                    <div className="relative flex flex-col items-end justify-center">
                        <div className="absolute w-full sm:bg-linear-to-tl bg-linear-to-l xl:bg-linear-to-tl from-20% to-60% from-black to-white/0 h-full flex items-end">
                        ...
                        <img
                            src={`/assets/cerita-dari-megahnya-masjid-istiqlal/doc-5.png`}
                            alt=""
                            width={772}
                            height={462}
        ...
        <section className="relative flex flex-col items-center space-y-6 sm:space-y-10 bg-white pb-20 pt-10 text-black md:pt-40 overflow-hidden">
            ...
            <ImageAnimation start="left">
                <img
                    src={`/assets/cerita-dari-megahnya-masjid-istiqlal/doc-3.png`}
                    alt=""
                    width={700}
                    height={393}
                    className="h-auto w-full"
        ...
        <section className="relative bg-black  flex flex-col items-center pt-10 text-custom-yellow px-0 md:px-20 md:pt-40 overflow-hidden">
            <img
                src={`/assets/cerita-dari-megahnya-masjid-istiqlal/cover-3.png`}
                alt=""
                width={1739}
                height={1737}
                className="absolute bottom-0 h-auto w-full opacity-50"
            />
            <div className="absolute -bottom-40 left-0 -z-10 h-160 w-full bg-linear-to-t from-transparent via-[rgb(0_0_0/1)_30%] to-transparent" />
            <Heading
                className="prose py-8 px-4 xl:px-0 text-center mx-auto text-custom-yellow!"
                color="#FEDC60">
                <h3 className="heading ">
            ...
            <Paragraph className="text-custom-yellow">
                <>
                    <p>
            ...
            <div className="flex w-full flex-col items-center">
                <ImageAnimation start="right">
                    <img
                        src={`/assets/cerita-dari-megahnya-masjid-istiqlal/doc-4.png`}
                        alt=""
                        width={920}
                        height={420}
        ...
        <section className="relative flex bg-black flex-col items-center space-y-6 sm:space-y-10 pt-10 text-custom-yellow lg:px-20 overflow-hidden">
            ...
            <img
                src={`/assets/cerita-dari-megahnya-masjid-istiqlal/cover-4.png`}
                alt=""
                width={2178}
                height={1226}
                className="absolute bottom-0 h-auto w-full opacity-50"
            />
            <div className="absolute -bottom-20 left-0 -z-10 h-80 w-full bg-linear-to-t from-[rgb(0_0_0/1)_10%] to-transparent" />
        </section>
        <section className="pb-12 bg-black sm:pb-120 relative flex flex-col items-center pt-10 lg:px-20 overflow-hidden text-custom-yellow">
            <Heading
                className="prose py-8 px-4 xl:px-0 text-center mx-auto text-custom-yellow!"
                color="#FEDC60">
                <h3 className="heading text-custom-yellow">
            ...
            <img
                src={`/assets/cerita-dari-megahnya-masjid-istiqlal/cover-5.png`}
                alt=""
                width={1703}
                height={959}
                className="absolute bottom-0 h-auto w-full"
            />
            <div className="absolute bottom-0 left-0 h-80 w-full bg-linear-to-t from-custom-yellow/50" />
        </section>
    </>
}
