...
export function SectionTwoComponent() {
    return <>
        <section className="bg-linear-to-b from-[#ffeca8] to-custom-yellow text-black">
            <div className="w-full relative">
                <img src={`/assets/cerita-dari-megahnya-masjid-istiqlal/istiqlal.webp`} alt="Masjid Istiqlal" className="w-full h-screen relative sm:h-[500px] object-cover object-center " />
                <div className="absolute inset-0 bg-linear-to-b from-black/40 to-black/55" />
                <motion.h2
                    initial={{ opacity: 0 }}
            ...
            <Image imageUrl='/assets/cerita-dari-megahnya-masjid-istiqlal/ragam-simbol-masjid.webp'
        ...
        <section className="relative bg-black" style={{ background: `url('/assets/cerita-dari-megahnya-masjid-istiqlal/tiang.jpeg'),linear-gradient(rgba(0,0,0,0.2),rgba(0,0,0,1))`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
            <div className="bg-linear-to-b from-black via-black/50 to-black h-full z-0 w-full absolute top-0 " />
            <div className="mx-auto prose py-8 flex flex-col relative">
                ...
                <div className="bg-custom-yellow text-black p-5 flex flex-col gap-5">
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="relative">
                        <img src={`/assets/cerita-dari-megahnya-masjid-istiqlal/tiang.webp`} alt="tiang raksasa" className="relative w-full h-full object-cover opacity-85 m-0" />
                    ...
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="relative">
                        <img src={`/assets/cerita-dari-megahnya-masjid-istiqlal/lima-lantai.webp`} alt="lima lantai" className="relative w-full h-full object-cover opacity-85 m-0" />
                        <div className="absolute bottom-0 bg-white w-full p-1">
                            <p className="text-sm sm:text-lg font-semibold px-2 my-0">
                    ...
                    <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="relative">
                        <img src={`/assets/cerita-dari-megahnya-masjid-istiqlal/kubah-masjid.webp`} alt="kubah masjid" className="relative w-full h-full object-cover opacity-85 m-0" />
                        <div className="absolute bottom-0 bg-white w-full p-1">
                            <p className="text-sm sm:text-lg font-semibold px-2 my-0">
