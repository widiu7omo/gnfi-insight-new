...
export function CustomImageD() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div className="absolute inset-0 h-80 bg-linear-to-b from-[#964666] z-10"></div>
      <div className="absolute bottom-0 inset-x-0 h-80 bg-linear-to-t from-[#f67384] z-10"></div>
      <div
        className="relative w-full justify-center bg-cover bg-center pb-12 pt-16 md:pb-32 md:pt-24 xl:pb-40"
        style={{ backgroundImage: `url(/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/4.1.jpg)` }}
      >
        <div className="relative mx-auto max-w-4xl lg:px-0 md:px-8 px-4">
          <div className="w-full relative z-10">
            <motion.h2
              className="font-sora text-[#FBD690] font-bold w-full text-center text-[32px] md:text-[43px] lg:text-[3.2rem] md:leading-14"
            ...
            <motion.p
              className="mt-4 md:mt-6 font-sora text-center mx-auto text-white w-full w-[78%] text-xl md:text-[1.7rem] md:leading-10"
            ...
            <div className="flex flex-row items-center">
              <div className="flex flex-row items-center w-2/5 md:w-1/3 space-x-0 md:space-x-4">
                <motion.p
                  ...
                  viewport={{ once: true, amount: 0.5 }}
                  className="text-white grow font-sora font-semibold text-xs md:text-2xl lg:text-3xl w-[40%]"
                >
                  PDRB Prov. NTB
                </motion.p>
              </div>
            ...
            <div className="flex flex-row items-center">
              <div className="flex flex-row items-center w-1/3 md:w-1/3 md:space-x-4">
                <motion.p
                  ...
                  transition={{ duration: 0.8, ease: "easeOut" }}
                  viewport={{ once: true, amount: 0.5 }}
                  className="text-white grow font-sora font-semibold ml-1 md:ml-0 text-sm md:text-2xl lg:text-3xl w-[40%]"
                >
                  Prov. NTB
                </motion.p>
              </div>
