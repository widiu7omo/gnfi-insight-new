...
export function CustomImageE() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        <div className="relative mx-auto max-w-4xl lg:px-0 md:px-8 pl-4 justify-center flex md:flex-row-reverse flex-col pt-12 md:pt-24">
          ...
          <motion.div className="w-full relative">
            <motion.img
              src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/5.1.1.png'}
              alt="Erick Thohir"
      ...
      <div
        className="z-20 relative w-full justify-center bg-no-repeat bg-top bg-cover xl:pb-24"
        style={{ backgroundImage: `url('/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/5.2.png')` }}
      >
        <div className="relative mx-auto max-w-4xl lg:px-0 md:px-8 pl-4 justify-center flex md:flex-row flex-col pt-12 md:pt-24">
          ...
          <motion.div className="w-full relative">
            <motion.img
              src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/5.3.png'}
