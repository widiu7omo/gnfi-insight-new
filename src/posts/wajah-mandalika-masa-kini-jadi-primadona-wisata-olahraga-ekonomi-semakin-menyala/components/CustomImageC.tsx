...
export function CustomImageC() {
  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div className="absolute inset-0 z-10 h-80 bg-linear-to-b from-[#31124B]"></div>
      <div
        className="relative w-full justify-center bg-cover bg-center pb-12 pt-16 md:pb-32 md:pt-24 xl:pb-48"
        style={{ backgroundImage: `url('/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/3.4.png')` }}
      >
        <div className="relative mx-auto max-w-4xl px-4 md:px-8 lg:px-0">
          <div className="relative flex flex-col md:flex-row">
            <div className="relative z-10">
              <motion.h2
                className="w-full font-sora text-[32px] font-bold text-[#45D80B] md:text-[43px] md:leading-14 lg:text-[3.2rem] lg:leading-18"
              ...
              <motion.p
                className="mt-8 font-sora text-xl text-white md:mt-12 md:text-[1.7rem] md:leading-10 lg:leading-10"
          ...
          <div className="relative z-20 mx-auto w-full rounded-3xl bg-[#C44E5E]">
            ...
            <div className="relative mt-4 flex flex-row justify-center px-2 md:mt-12 md:px-24">
              <div className="w-1/2">
                ...
                <div className="mt-4 flex h-100 items-end justify-center space-x-2 md:h-160 md:space-x-6">
              ...
              <div className="absolute bottom-0">
                <motion.img
                  src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/3.3.png'}
                  alt="People"
      ...
      <div className="absolute bottom-0 z-10 h-80 w-full bg-linear-to-t from-[#964666]"></div>
