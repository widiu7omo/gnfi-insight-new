...
export function CustomImageA() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden bg-linear-to-b from-[#8d182c] to-90% to-[#e5024b] pt-12">
      <div className="relative w-full">
        <div className="mx-auto max-w-4xl px-6 md:px-8 lg:px-0">
          <motion.h2
            className="mb-6 font-sora text-[24px] font-bold leading-tight text-[#fff400] sm:text-[28px] md:mb-12 md:text-[40px] md:leading-14 lg:text-[48px]"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
        ...
        >
          <motion.div
            className="absolute z-10 inset-x-4 -bottom-5 top-60 h-fit rounded-3xl bg-white sm:inset-x-6 sm:top-[266px] md:inset-0 md:left-8 md:mr-[40%] md:h-auto lg:left-0"
            variants={slideFromLeft}
          >
            <motion.p
              className="block relative z-40 p-6 font-sora text-base font-semibold leading-[1.6] text-[#3b3a3c] sm:p-8 sm:text-lg md:hidden md:text-2xl md:leading-10"
              variants={fadeUp}
            >
          ...
          >
            <motion.p
              className="font-sora relative z-40 text-base font-semibold leading-[1.6] text-[#3b3a3c] sm:text-lg md:text-xl md:leading-10 lg:text-2xl"
              variants={fadeUp}
            >
              Sejak era kolonial Belanda, Pulau Lombok tempat Mandalika berada
              sudah menjadi destinasi wisata.
          ...
          >
            <motion.img
              src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/1.1.jpg'}
              alt="Land of Lombok"
        ...
        <div className="relative mx-auto flex h-fit w-full max-w-4xl flex-col-reverse items-center px-4 sm:px-6 md:flex-row md:items-center md:px-8 lg:px-0 mt-32 md:mt-0">
          <motion.div
            className="relative mb-20 mt-20 xs:mt-0 flex flex-col items-center gap-4 rounded-3xl p-4 sm:gap-6 sm:p-6 md:flex-row md:items-center md:gap-8 md:p-10 lg:gap-12"
            variants={staggered}
            initial="hidden"
            whileInView="visible"
        ...
        >
          <motion.div
            className="absolute inset-0 z-20 bg-linear-to-t from-[#e5024b] from-50% md:from-20% md:to-80%"
            variants={{ ...fadeUp, visible: { ...fadeUp.visible, transition: { ...fadeUp.visible.transition, delay: 0.7 } } }}
          ></motion.div>
          <motion.div className="absolute z-0 -mt-24 xs:-mt-20 lg:mt-[8%] xl:mt-[10%] sm:-mt-8 md:mt-0 "
          ...
          >
            <img
              src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/1.3.png'}
              alt="Sun"
              className="scale-[.3] xs:scale-[.35] sm:scale-[.5] md:scale-[.7] lg:mr-16 lg:scale-[1] xl:scale-125 opacity-30 sm:opacity-100"
            />
          </motion.div>
          <motion.img
            src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/1.4.png'}
            alt="Scenery"
            className="relative z-10 w-full object-cover"
            variants={slideFromBottom}
          />
          <motion.div
            className="lg:absolute -mt-60 lg:mt-0 md:inset-0 z-20 mx-auto flex max-w-4xl flex-col justify-end px-4 sm:px-6"
            variants={staggered}
          >
            <motion.div
            ...
            <motion.div className="pt-8 sm:pt-12" variants={fadeUp}>
              <motion.img
                src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/1.5.png'}
                alt="Ocean"
                className="w-full"
                variants={subtleScale}
              />
        ...
        >
          <motion.img
            src={'/assets/wajah-mandalika-masa-kini-jadi-primadona-wisata-olahraga-ekonomi-semakin-menyala/footer.png'}
