...
export function CustomImageE() {
  ...
  return (
    <motion.div
      className="relative flex flex-col noise2 items-center overflow-hidden font-sora bg-no-repeat bg-position-[center_top_0%] bg-cover bg-[url('/assets/kereta-cepat-jakarta-surabaya-misi-ambisius-di-antara-2-sisi-pulau-jawa/4.1.png')]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        <div className="space-y-4 px-4 lg:px-0 w-full">
          ...
          <motion.div
            ref={subtitleRef}
            className="font-bold px-3 py-1 bg-white text-black w-fit text-2xl sm:text-3xl lg:text-4xl"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div className="flex flex-col md:flex-row md:items-end bg-[#93010d] w-full rounded-t-md md:rounded-t-[2.5rem] relative">
              <motion.img
                src={'/assets/kereta-cepat-jakarta-surabaya-misi-ambisius-di-antara-2-sisi-pulau-jawa/4.2.png'}
                alt="SBY"
                className="w-auto h-28 md:h-auto md:w-1/2 right-0 md:right-auto left-auto md:left-0 bottom-0 absolute"
            ...
            <div className="flex flex-col md:flex-row md:items-end bg-[#202020] px-4 md:px-8 relative">
              ...
              <motion.img
                src={'/assets/kereta-cepat-jakarta-surabaya-misi-ambisius-di-antara-2-sisi-pulau-jawa/4.3.png'}
                alt="Jokowi"
                className="w-auto h-28 md:h-auto md:w-[30%] right-0 absolute bottom-0"
                initial={{ opacity: 0, x: 20 }}
                animate={subtitleInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 20 }}
                transition={{ duration: 0.8, delay: 0.8, ease: "easeOut" }}
              />
            ...
            <div className="flex flex-col md:flex-row md:items-end bg-[#dfdfdf] px-4 md:px-8 rounded-b-md md:rounded-b-[2.5rem] overflow-clip md:overflow-visible relative">
              <motion.img
                src={'/assets/kereta-cepat-jakarta-surabaya-misi-ambisius-di-antara-2-sisi-pulau-jawa/4.4.png'}
                alt="Prabowo"
              ...
              >
                ...
                <motion.div
                  className="mt-8 flex space-x-4 sm:pt-12 md:ml-0 xs:ml-[35%] ml-0"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="py-8 relative">
                      ...
                      <motion.img
                        src={'/assets/kereta-cepat-jakarta-surabaya-misi-ambisius-di-antara-2-sisi-pulau-jawa/4.5.png'}
                        alt="AHY"
                        className="absolute -left-18 top-2 sm:-left-20 md:-left-36 sm:top-4 md:-top-6 w-[25%] sm:w-[20%] md:w-[40%]"
