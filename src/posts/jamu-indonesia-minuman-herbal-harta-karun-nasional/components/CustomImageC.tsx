      ...
      >
        ...
        <div className="relative w-full justify-center bg-[#3E0703] pt-16 md:pt-24 pb-12 md:pb-[8rem] xl:pb-24 mt-[20%] rounded-t-full">
          <div className="relative mx-auto max-w-4xl lg:px-0 md:px-8 px-4 pt-14 md:pt-16 lg:pt-20">
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.2.png`}
              alt="Galian Singset"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.1.png`}
              alt="Beras Kencur"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.3.png`}
              alt="Kunci Sirih"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.4.png`}
              alt="Kunyit Asam"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.5.png`}
              alt="Kudu Laos"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.8.png`}
              alt="Pahitan"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.7.png`}
              alt="Jamu Cekok"
            ...
            <motion.img
              src={`/assets/jamu-indonesia-minuman-herbal-harta-karun-nasional/3.6.png`}
              alt="Sinom"
