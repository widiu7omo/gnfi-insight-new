...
export function CustomImageB() {
  ...
  return (
    <motion.div
      ...
      style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/2.1.png)` }}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className="w-full max-w-4xl mx-auto h-fit relative">
        ...
        >
          <motion.img
            src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/2.2.png'}
          ...
          >
            <motion.h6
              className="text-2xl lg:text-[3.6rem] lg:leading-16 text-white font-bold"
      ...
      >
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
        >
          <img src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/2.3.png'} alt="Polygon" />
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            <img src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/2.4.png'} alt="Element" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={brandsInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 30 }}
            ...
            whileHover={{ scale: 1.05, transition: { duration: 0.3 } }}
          >
            <img src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/2.5.png'} alt="Pacific" />
          </motion.div>
        </motion.div>
        <motion.div
          ref={questionRef}
