...
export function CustomImageE() {
  ...
  return (
    ...
    >
      <div
        className="relative w-full justify-center bg-cover bg-position-[center_40%] pt-6 md:pt-20 lg:py-32 lg:pb-4"
        style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/5.1.1.jpg)` }}
      >
        ...
        >
          <motion.div
            className="text-2xl px-4 lg:px-0 lg:text-4xl xl:text-6xl font-bold text-center leading-tight text-black"
          ...
          >
            ...
            <motion.span
              className="text-[#ffbc25] text-stroke stroke-black"
          ...
          <motion.div
            className="text-base lg:text-2xl text-center lg:text-left px-4 lg:px-0 lg:max-w-[85%] mx-auto leading-relaxed text-black"
          ...
          <img src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/5.2.png'} alt="Man with bike" className="opacity-0 max-h-360" />
          <motion.div
            ref={questionRef}
            className="absolute bottom-100 flex items-center justify-center w-full"
      ...
      <div className="absolute top-0 h-[10%] w-full bg-linear-to-b from-[#e5e5e5]" />
      <motion.div
