  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.1.jpg)` }}
      >
        <div className="absolute bottom-[-2px] w-full h-full block lg:hidden bg-linear-to-t from-white"></div>
        <motion.div
          ref={heroRef}
          className="max-w-4xl mx-auto pb-28 relative z-10"
        >
          <motion.div
            className="w-full lg:w-[70%] space-y-8 px-4 lg:px-0 text-black"
          ...
          >
            ...
            <motion.div
              className="text-xl lg:text-3xl font-semibold pr-32"
            ...
            <motion.div
              className="text-base lg:text-xl font-medium pr-32"
        ...
        <div className="absolute bottom-0 w-full bg-linear-to-t from-[#bda686] h-[60%] hidden lg:block 2xl:hidden"></div>
      </div>
      <motion.div
        ref={competitionRef}
        className="relative w-full h-120 bg-cover bg-right"
        style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.3.png)` }}
      >
        <div className="h-full absolute w-full bg-linear-to-b from-20% block lg:hidden from-white" />
        <div className="h-full absolute w-full bg-linear-to-l from-20% hidden lg:block from-[#12150c]" />
        <div className="max-w-7xl h-full mx-auto relative flex flex-col">
          <motion.img
            src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.2.png'}
            alt="Gowes"
            className="bottom-0 lg:-top-[7.4rem] h-auto sm:h-80 left-0 sm:left-72 lg:left-0 lg:h-fit absolute object-bottom mt-auto w-full sm:w-fit lg:w-full"
      ...
      <div className="relative w-full py-8 lg:py-20 bg-cover bg-bottom" style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.4.jpg)` }}>
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            >
              <motion.img
                src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.5.png'}
                alt=""
                className="-mt-8"
                ...
                transition={{ duration: 0.6, delay: 0.6 }}
              />
              <div className="text-base lg:text-xl tracking-wide mt-4 leading-normal text-black">Bisa dilihat di Tanjung Priok, Jakarta Utara, <b>ojek sepeda</b> tetap eksis meski harus bersaing dengan transportasi bermotor.</div>
            </motion.div>
            <motion.div
              className="bg-[#ffbc25] shadow-lg lg:rounded-[3rem] flex lg:flex-row flex-col items-start p-4 lg:p-6 lg:space-x-8"
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              <motion.img
                src={'/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/4.6.png'}
                alt=""
                className="-mt-8"
                initial={{ opacity: 0, scale: 0.8 }}
                animate={cardsInView ? { opacity: 1, scale: 1 } : { opacity: 0, scale: 0.8 }}
                transition={{ duration: 0.6, delay: 0.8 }}
              />
              <div className="text-base lg:text-xl tracking-wide mt-4 leading-normal text-black">Lalu di lingkup kepariwisataan sepeda suka dihadirkan sebagai hiburan memanjakan turis yang ingin merasakan sensasi <b>bersepeda di alam</b> pedesaan Indonesia.</div>
            </motion.div>
          </motion.div>
        </div>
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
        >
          <Paragraph className="max-w-[65ch] mx-auto text-white font-sans"
          >
            <>
