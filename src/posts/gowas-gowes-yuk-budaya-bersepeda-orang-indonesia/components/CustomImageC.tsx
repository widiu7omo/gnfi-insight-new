...
export function CustomImageC() {
  ...
  return (
    <motion.div
      ...
      style={{ backgroundImage: `url(/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/3.1.png)` }}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <motion.div
        ref={heroRef}
        className="max-w-4xl mx-auto pt-0 lg:pt-80 pb-8 z-10"
      >
        <motion.div
        ...
        >
          <motion.div
            className="text-3xl sm:text-4xl xl:text-6xl text-black font-bold leading-snug"
      ...
      <motion.div
        ref={cardsRef}
        className="max-w-4xl mx-auto pb-40 z-10"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <motion.div
            className="bg-white rounded-xl shadow-lg p-6 space-y-6 text-black"
          ...
          >
            <motion.img
              src={"/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/3.2.jpg"}
              alt="Bike Garage"
            ...
            <motion.p
              className="font-neutral-800 text-lg text-black"
          ...
          >
            ...
            <motion.img
              src={"/assets/gowas-gowes-yuk-budaya-bersepeda-orang-indonesia/3.3.png"}
              alt="Stats"
              initial={{ opacity: 0, scale: 0.9 }}
              animate={
                cardsInView
      ...
      <div className="absolute bottom-0 h-full w-full bg-linear-to-t from-black z-0 to-60%" />
      <motion.div
