  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden ">
      <div
        ...
        style={{ backgroundImage: `url(/assets/derap-tren-olahraga-lari-masa-kini/2.0.jpg)` }}
      >
        <div className="absolute w-full h-[50%] bg-linear-to-b from-[#f9bea8] top-0" />
        <div className="z-10 max-w-4xl mx-auto">
          <div className="relative space-y-2 inset-x-0 z-10 mb-4 text-center font-sora text-3xl font-bold text-white md:text-6xl flex flex-col justify-center items-center">
            <motion.h3
              ...
              className="bg-[#9d2d3d] px-4 py-2 rounded-xl wrap-break-word w-fit">Lari, Olahraga Favorit</motion.h3>
            <motion.h3
              viewport={{ once: true }}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.4 }}
              className="bg-[#9d2d3d] px-4 py-2 rounded-xl wrap-break-word w-fit">Anak Muda Indonesia</motion.h3>
          </div>
          <div ref={ref} className="mt-40 relative">
            <div className="absolute left-4 xl:left-0 top-0 space-y-4 z-10">
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2, duration: 0.4 }}
                src={"/assets/derap-tren-olahraga-lari-masa-kini/2.2.png"} alt="2.2" className="" />
            </div>
            <div className="absolute lg:-right-16 xl:-right-52 top-16 items-start flex-col z-10 lg:flex hidden">
              ...
              <div className="w-40 -mt-32 z-0 h-60 rounded-br-3xl border-[3px] border-t-transparent border-l-transparent border-dashed bg-transparent"></div>
            </div>
            <div className="absolute lg:-left-16 xl:-left-24 top-112 lg:flex hidden items-end flex-col z-10">
              <div className="w-40 -mb-32 relative z-0 h-60 rounded-tl-3xl border-[3px] border-b-transparent border-r-transparent border-dashed bg-transparent"></div>
              <div className="rounded-xl overflow-clip z-10 relative">
            ...
            <motion.img
              ...
              src={"/assets/derap-tren-olahraga-lari-masa-kini/2.1.png"} alt="People Run" className="w-full h-full object-contain relative z-1" />
          </div>
          ...
          <img src={"/assets/derap-tren-olahraga-lari-masa-kini/2.3.png"} alt="Background" className="w-full h-full absolute left-0 top-[35%] z-0" />
          <motion.div
            viewport={{ once: true }}
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: .5 }}
            className="relative z-10 mt-64 xl:mt-40 px-8 xl:px-0 space-y-4 xl:space-y-8">
            <img src={"/assets/derap-tren-olahraga-lari-masa-kini/2.5.png"} alt="Quote 2" className="size-8 md:size-12 xl:size-fit object-contain absolute top-[-0.7rem] xl:-top-6 left-2 xl:-left-16" />
            ...
            <img src={"/assets/derap-tren-olahraga-lari-masa-kini/2.4.png"} alt="Quote 1" className="size-8 md:size-12 xl:size-fit object-contain absolute bottom-14 right-2 xl:bottom-18 xl:-right-16" />
          </motion.div>
          <div className="absolute w-full left-0 bottom-0 bg-linear-to-t from-[#8c1239] h-[20%] z-0"></div>
          <img src={`/assets/derap-tren-olahraga-lari-masa-kini/footer.png`} className="z-50 hidden sm:block relative bottom-0 h-fit w-fit mx-auto" />
        </div>
      </div>
    </div>
  );
