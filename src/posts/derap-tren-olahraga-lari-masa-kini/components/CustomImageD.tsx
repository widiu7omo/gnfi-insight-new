...
export function CustomImageD() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div className="absolute h-[20%] w-full left-0 z-10 top-0 bg-linear-to-b from-[#942238]"></div>
      <div
        className="relative flex h-full w-full flex-col justify-center bg-cover bg-center pb-12 text-center md:pb-32"
        style={{ backgroundImage: `url(/assets/derap-tren-olahraga-lari-masa-kini/3.0.png)` }}
      >
        <div className="relative w-full">
          <img
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.1.png`}
            alt="Header"
            className="relative z-0 min-h-37.5 w-full object-cover"
          />
        </div>
        <div className="relative z-10 mx-auto -mt-[55%] w-full px-4 md:max-w-4xl md:px-0 lg:-mt-[55%]">
          ...
          <motion.img
            ...
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.2.png`}
            alt="910 Nineten"
          ...
          <motion.img
            ...
            whileInView={{ opacity: 1, x: 0, scale: 1.1 }}
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.3.png`}
            alt="Ortu Seigth"
          ...
          <motion.img
            ...
            whileInView={{ opacity: 1, x: 0, scale: 1.1 }}
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.4.png`}
            alt="Mills"
          ...
          <motion.img
            ...
            whileInView={{ opacity: 1, x: 0, scale: 1.1 }}
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.5.png`}
            alt="SPECS"
          ...
          <motion.img
            ...
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/derap-tren-olahraga-lari-masa-kini/3.6.png`}
            alt="Eagle"
