  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/derap-tren-olahraga-lari-masa-kini/4.10.png)` }}
      >
          ...
          <div className="w-full md:w-1/2">
              ...
              <div className="relative">
                <div className="flex h-28 w-28 items-center justify-center rounded-full bg-[#062788]">
                  <motion.img
                    ...
                    src={`/assets/derap-tren-olahraga-lari-masa-kini/4.1.png`}
                    alt="Lari"
            ...
            <div className="relative mt-8 flex items-center justify-between md:mt-12">
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/derap-tren-olahraga-lari-masa-kini/4.2.png`}
                alt="Kalendar"
              ...
              <div className="relative">
                <div className="flex h-28 w-28 items-center justify-center rounded-full bg-[#062788]">
                  <motion.img
                    ...
                    whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                    transition={{ duration: 0.8, ease: "backOut" }}
                    src={`/assets/derap-tren-olahraga-lari-masa-kini/4.3.png`}
                    alt="Medali"
        ...
        <div className="z-10 mx-auto mb-12 flex w-full max-w-4xl items-center px-4 md:mb-20 lg:px-0">
          ...
          <div className="relative w-full md:w-1/2">
            <motion.img
              ...
              src={`/assets/derap-tren-olahraga-lari-masa-kini/4.4.png`}
              alt="Lari"
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center items-stretch space-x-0 px-4 md:flex-row md:space-x-8 lg:px-0">
          <div className="relative flex hidden w-1/3 justify-center rounded-xl bg-[#062788] p-4 md:flex">
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/derap-tren-olahraga-lari-masa-kini/4.5.png`}
              alt="Lari"
            ...
            <motion.p
              ...
              className="absolute bottom-4 text-center text-lg sm:text-xl text-white md:text-2xl"
            >
          ...
          <div className="mb-4 w-full md:hidden">
            <div className="relative flex min-h-32 w-full justify-between rounded-xl bg-[#062788] p-4">
              <motion.p
                viewport={{ once: true }}
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                className="relative flex w-1/2 items-center pr-4 text-left text-lg sm:text-xl text-white md:pr-20 md:text-2xl"
              >
                Pilih sepatu <br /> yang nyaman
              </motion.p>
              <motion.img
          ...
          <div className="w-full space-y-4 md:w-2/3 md:space-y-8">
            <div className="relative flex min-h-32 w-full flex-row-reverse justify-between rounded-xl bg-[#062788] p-4">
              <motion.img
                viewport={{ once: true }}
                initial={{ opacity: 0, y: 50, scale: 0.8 }}
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/derap-tren-olahraga-lari-masa-kini/4.6.png`}
                alt="Bulan"
                className="absolute -top-2 left-4 z-20 h-auto w-[30%] md:-top-4 lg:-top-12"
              />
              <motion.p
                viewport={{ once: true }}
                initial={{ opacity: 0, x: 50 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                className="relative flex ml-[30%] pl-6 flex-1 items-center pr-4 text-left text-lg sm:text-xl text-white md:text-2xl"
              >
            ...
            <div className="relative flex min-h-32 w-full justify-between rounded-xl bg-[#062788] p-4">
              <motion.p
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                className="relative flex items-center mr-[30%] pr-4 text-left text-lg sm:text-xl text-white md:text-2xl"
              >
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/derap-tren-olahraga-lari-masa-kini/4.7.png`}
                alt="Matahari"
                className="absolute -top-3 right-0 z-20 h-auto w-[30%] md:-top-4 lg:-bottom-4 lg:-top-7"
              />
            </div>
          </div>
        </div>
        <div className="mx-auto mt-4 flex w-full max-w-4xl flex-col items-stretch space-x-0 space-y-4 px-4 md:mt-8 md:flex-row md:space-x-8 md:space-y-0 lg:px-0">
          <div className="relative flex h-auto w-full rounded-xl bg-[#062788] md:w-1/2">
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/derap-tren-olahraga-lari-masa-kini/4.9.png`}
              alt="Lari"
              className="left-0 top-0 h-full w-[150px] lg:w-[200px] rounded-l-xl object-cover"
            />
            <div className="relative z-10 flex flex-1 items-center justify-center px-4">
              <motion.p
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                className="font-sora text-lg sm:text-xl text-white md:text-2xl"
              >
          ...
          <div className="relative flex min-h-32 w-full rounded-xl bg-[#062788] md:w-1/2">
            <motion.img
              viewport={{ once: true }}
              initial={{ opacity: 0, y: 50, scale: 0.8 }}
              whileInView={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/derap-tren-olahraga-lari-masa-kini/4.8.png`}
              alt="Tangan"
