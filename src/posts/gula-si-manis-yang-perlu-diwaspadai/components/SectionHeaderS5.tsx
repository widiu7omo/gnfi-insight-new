...
export function SectionHeaderS5() {
    return (
        <>
            {/* Header */}
            <div className={cn("flex h-full relative flex-col items-center justify-start bg-cover bg-no-repeat bg-position-[center_top_20%]",
            )}
                style={{
            ...
            >
                <motion.img
                    ...
                    viewport={{ once: true }}
                    src={`/assets/gula-si-manis-yang-perlu-diwaspadai/5.2.png`} />
                <div className="relative flex md:flex-row flex-col space-y-4 md:space-y-0 space-x-0 md:space-x-4 justify-end md:justify-center items-center md:items-end h-[800px] w-full overflow-clip">
                    <motion.img
                        ...
                        src={`/assets/gula-si-manis-yang-perlu-diwaspadai/5.3.png`} />
                    <motion.img
                        initial={{ x: 20, opacity: 0 }}
                        ...
                        viewport={{ once: true }}
                        className="overflow-hidden size-[400px] object-cover"
                        src={`/assets/gula-si-manis-yang-perlu-diwaspadai/5.4.png`} />
                </div>
                {/* Paragraph */}
                ...
                <Image imageUrl="/assets/gula-si-manis-yang-perlu-diwaspadai/5.5.png"
