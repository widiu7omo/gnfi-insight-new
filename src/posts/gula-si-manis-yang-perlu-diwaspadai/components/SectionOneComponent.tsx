...
export function SectionOneComponent() {
    return <section id="section-1" className="bg-[#fffcf3] -mt-1 overflow-clip ">
        <div className="flex flex-col h-[300px] items-center justify-center bg-cover bg-center">
            <h2 className="max-w-5xl px-4 sm:px-0 text-center text-3xl font-bold leading-snug lg:text-4xl xl:text-5xl relative">
                ...
                <motion.img
                    ...
                    src={`/assets/gula-si-manis-yang-perlu-diwaspadai/sugar2.svg`} alt="Sack" className="absolute -right-40 -top-32 size-80" />
                <motion.img
                    initial={{ x: 20, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1 }}
                    transition={{ ease: 'easeInOut', duration: .5, }}
                    src={`/assets/gula-si-manis-yang-perlu-diwaspadai/sugar.svg`} alt="Sugar Plate" className="absolute right-0 xl:-right-48 -top-2 size-88" />
            </h2>
        </div>
        <div className="mb-16">
            <Paragraph>
        ...
        <div className="relative flex items-start justify-center overflow-clip">
            <div className="w-full bg-cover bg-no-repeat bg-position-[center_top_-8rem]" >
                <div className="absolute z-0 bg-linear-to-b top-0 bottom-[10%] left-0 right-0 from-[#fffcf3] to-80% to-black/0" />
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="space-y-0">
                        <div className="relative flex items-center justify-center z-0">
                            <img src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.0.png`} className="top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: 20 }}
                                viewport={{ once: true }}
                                whileInView={{ opacity: 1, x: 0 }}
                                transition={{ delay: 0.4, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.2.png`} alt="Title" className="absolute top-0" />
                            <motion.img
                                initial={{ opacity: 0, x: 20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.8, duration: .3 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.1.png`} className="absolute" alt="Sub Title" />
                            <motion.img
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.5, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.3.png`} className="absolute top-0" alt="Shy Lg" />
                        </div>
                    </div>
                </div>
                <motion.img
                    ...
                    src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.4.png`} className="top-0 object-contain px-40 bottom-0 w-full h-full absolute" alt="Shy Lg" />
                <div className="top-0 object-contain bottom-0 w-full h-full absolute bg-linear-to-b from-white/0 to-black/30 backdrop-blur-3xl" />
                <div className="max-w-7xl mx-auto relative z-10 -mt-40 sm:-mt-60 lg:-mt-100 xl:-mt-116">
                    <div className="space-y-0">
                        <div className="relative flex items-center justify-center z-0">
                            <img src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.4.png`} className="top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: -10, y: 90 }}
                                whileInView={{ opacity: 1, x: 0, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 1, duration: .3 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.18.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, y: 20 }}
                                viewport={{ once: true }}
                                whileInView={{ opacity: 1, y: 0 }}
                                transition={{ delay: 0.4, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.5.png`} alt="Title" className="absolute top-0" />
                            <motion.img
                                initial={{ opacity: 0 }}
                                whileInView={{ opacity: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.3, duration: .3 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.6.png`} className="absolute" alt="Sub Title" />
                            <motion.img
                                initial={{ opacity: 0, }}
                                whileInView={{ opacity: 1, }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.4, duration: .3 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.7.png`} className="absolute" alt="Sub Title" />
                            <motion.img
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.3, duration: .3, ease: "easeOut", }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.6.1.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, scale: .7 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.4, duration: .3, ease: "easeOut", }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.8.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, scale: .7 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.5, duration: .3, ease: "easeOut", }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.9.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, scale: .7 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.6, duration: .3, ease: "easeOut", }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.10.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, scale: .7 }}
                                whileInView={{ opacity: 1, scale: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.7, duration: .3, ease: "easeOut", }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.11.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: -20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.2, duration: .5 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.12.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: -20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.3, duration: .5 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.13.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: -20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.4, duration: .5 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.14.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: 20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.2, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.15.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, x: 20 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.3, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.16.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0 }}
                                whileInView={{ opacity: 1 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0, duration: .3 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.17.png`} className="absolute top-0" alt="Shy Lg" />
                            <motion.img
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                transition={{ delay: 0.5, duration: .8 }}
                                src={`/assets/gula-si-manis-yang-perlu-diwaspadai/1.19.png`} className="absolute top-0" alt="Shy Lg" />
                        </div>
                    </div>
                </div>
