...
export function SectionTwoCustomImage() {
    return <div className="bg-cover relative xl:bg-center bg-position-[center_top]" >
        <div className="absolute right-0 bottom-0 top-0 left-0 bg-no-repeat bg-cover" />
        <div className="absolute bg-linear-to-b to-20% z-10 left-0 right-0 top-0 bottom-[40%]" />
            ...
            <div className="relative flex items-center justify-center">
                <div className="relative flex items-center justify-center">
                    ...
                    <motion.img
                        ...
                        src={`/assets/gula-si-manis-yang-perlu-diwaspadai/2.1.png`} className="relative top-0" alt="Title" />
                    ...
                    {/* <motion.img
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.2 }}
                            src={`/assets/gula-si-manis-yang-perlu-diwaspadai/2.2.png`} className="absolute top-0" alt="Title" /> */}
                </div>
            </div>
        </div>
        <div className="">
        ...
        <Carousel items={[
            {
                name: "Gula Pasir",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/pasir.png`,
                desc: <>
            ...
            {
                name: "Gula Semut",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/semut.png`,
                desc: <>
            ...
            {
                name: "Gula Merah",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/jawa.png`,
                desc: <>
            ...
            {
                name: "Gula Aren",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/aren.png`,
                desc: <>
            ...
            {
                name: "Gula Batu",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/batu.png`,
                desc: <>
            ...
            {
                name: "Gula Bit",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/bit.png`,
                desc: <>
            ...
            {
                name: "Gula Jagung",
                image: `/assets/gula-si-manis-yang-perlu-diwaspadai/jagung.png`,
                desc: <>
