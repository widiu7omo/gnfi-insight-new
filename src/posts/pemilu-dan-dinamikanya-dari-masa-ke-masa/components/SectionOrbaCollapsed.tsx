...
export function SectionOrbaCollapsed() {
  let indexImage = 0
      ...
      <div className="mx-auto flex items-center justify-center flex-col">
        ...
        <div className="w-full relative flex justify-center items-center h-[280px] min-[320px]:h-[300px] min-[380px]:h-[330px] min-[620px]:h-[480px] xs:h-[450px] sm:h-[500px] min-[670px]:h-[630px] min-[730px]:h-[580px] min-[680px]:h-[550px] md:h-[650px] xl:h-[700px]">
          <motion.div
            ...
            style={{
              background: `linear-gradient(0deg, rgba(26, 18, 24, 0.6), rgba(26, 18, 24, 0.6)), url('/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/collapsed/collapse.jpg')`,
              filter: 'blur(50px)',
              transform: 'scale(2)',
            }}
          />
          <motion.img
            ...
            src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/collapsed/collapse.jpg`}
            alt="Demo"
      ...
      <div className="mx-auto flex items-center justify-center flex-col">
        <div className="h-[280px] min-[320px]:h-[300px] min-[380px]:h-[330px] min-[620px]:h-[480px] xs:h-[450px] sm:h-[500px] min-[670px]:h-[630px] min-[730px]:h-[580px] min-[680px]:h-[550px] md:h-[650px] xl:h-[700px] w-full relative flex justify-center items-center">
          <motion.div
            ...
            style={{
              background: `linear-gradient(0deg, rgba(26, 18, 24, 0.6), rgba(26, 18, 24, 0.6)),url('/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/collapsed/collapse2.png')`,
              filter: 'blur(50px)',
              transform: 'scale(1.1)',
            }}
          />
          <motion.img
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5 }}
            src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/collapsed/collapse2.png`}
            alt="Demo 2"
            ...
            {new Array(7).fill(0).map((_, i) => {
              ...
              return (
                <motion.img
                  ...
                  src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/collapsed/${indexImage}.png`}
