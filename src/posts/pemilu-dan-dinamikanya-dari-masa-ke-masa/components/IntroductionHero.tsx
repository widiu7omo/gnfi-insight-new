...
export function IntroductionHero() {
  return (
    <div
      ...
      style={{
        background:
          `url(/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/tangerangkota.go.id.jpeg)`,
      }}
    >
      <div className="absolute w-full h-full bg-linear-to-b from-black/0 to-black/90">
