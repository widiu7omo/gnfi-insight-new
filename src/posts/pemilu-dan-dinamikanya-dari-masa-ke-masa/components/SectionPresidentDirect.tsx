...
export function SectionPresidentDirect() {
  return (
    <div className="w-full mx-auto bg-[#F6F0E2] flex items-center justify-center">
      <div className="flex flex-col w-full items-center justify-center space-y-4 max-w-full lg:max-w-7xl">
        <motion.h2
          ...
          className="font-bold text-2xl md:text:3xl text-black lg:text-4xl xl:text-5xl text-center my-6 max-w-[70%] leading-snug mx-auto"
        >
        ...
        <div className="px-4 xl:px-0">
          <motion.img
            ...
            src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/Wikimedia_Commons_(3).jpg`}
            alt="Surat Suara"
          />
        </div>
      </div>
