...
export function SectionHistoryFirstPemilu() {
  let indexImage = 2
    ...
    <div className="flex flex-row items-start justify-center w-full h-[500px] xs:h-[700px] sm:h-[850px] md:h-[1000px] lg:h-[1400px] xl:h-[1600px]">
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="absolute z-10 left-[49.50%] lg:left-[49.76%] h-[calc(100%-80px)] xs:h-[calc(100%-20px)] md:h-[calc(100%-200px)] top-5 xs:top-[100px] lg:top-[200px] w-0.5 bg-[#e36414]"
        />
        {new Array(8).fill(0).map((_, i) => {
          ...
          return (
            <motion.img
              ...
              src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/history/${indexImage}.png`}
