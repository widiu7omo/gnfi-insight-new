...
import { FirstElectionMethod } from './SectionFirstPemiluMethod'

export function SectionFirstPemiluOldImage() {
  ...
  return (
    <div
      className="w-full py-8 space-y-8 flex items-center justify-center flex-col shadow-[inset_0px_-2px_4.8px_2px_rgba(0,0,0,0.1),inset_0px_4px_4px_rgba(0,0,0,0.1)]"
      style={{
        background: `url('/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/canvas-first-pemilu.webp')`,
      }}
    >
      <div className="space-y-8 max-w-full lg:max-w-7xl px-4 xl:px-0 flex flex-col items-center">
        <motion.img
          ...
          src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/kulonprogokab.go.id.jpg`}
