...
import { CaptionFromWill } from './CaptionFromWill'
      ...
      <div className="flex flex-row items-start justify-center w-full h-[500px] xs:h-[700px] sm:h-[900px] md:h-[1000px] lg:h-[1200px] xl:h-[1200px]">
        ...
        >
          <motion.div
            ...
            className="absolute z-10 left-[49.63%] h-[calc(100%-100px)] xs:h-[calc(100%-100px)] md:h-[calc(100%-200px)] xl:h-[calc(100%-200px)] top-5 xs:top-[100px] lg:top-[200px] w-0.5 bg-black"
          />
          {new Array(8).fill(0).map((_, i) => {
            ...
            return (
              <motion.img
                ...
                src={`/assets/pemilu-dan-dinamikanya-dari-masa-ke-masa/golkar/${indexImage}.png`}
