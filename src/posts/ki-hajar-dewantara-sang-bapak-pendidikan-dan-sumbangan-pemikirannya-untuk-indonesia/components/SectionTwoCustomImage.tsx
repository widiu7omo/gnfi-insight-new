...
export function SectionTwoCustomImage() {
    return <section id="section-1" className="bg-[#fffcf3] -mt-1 overflow-clip ">
        <div className="relative flex items-start justify-center overflow-clip">
            <div className="w-full bg-cover bg-no-repeat bg-position-[center_top] relative" style={{ backgroundImage: `url('/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/1.0.png')` }}>
                    ...
                    <div className="space-y-0">
                        ...
                        <div className="relative flex items-center justify-center z-0">
                            ...
                            <motion.img
                                ...
                                src={`/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/1.19.png`} alt="Title" className="absolute top-0 invert" />
                        </div>
                    </div>
                </div>
