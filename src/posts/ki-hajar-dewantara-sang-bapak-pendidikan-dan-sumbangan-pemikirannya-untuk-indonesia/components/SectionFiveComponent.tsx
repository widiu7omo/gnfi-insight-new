...
export function SectionFiveComponent() {
    return <div style={{ backgroundImage: `url(/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.2.png)` }} className="bg-repeat">
        <SectionHeader title="Pola Hidup Sehat, Jurus Jitu Mencegah Kanker"
            coverImage="/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.1.png"
            className='bg-top' />
        <Paragraph>
            <>
        ...
        <div className="relative max-w-4xl mx-auto">
            <motion.img
                ...
                src={`/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.3.png`} alt="Illustration 1" className="absolute" />
            <motion.img
                initial={{ opacity: 0, x: 30 }}
                viewport={{ once: true }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2 }}
                src={`/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.3.1.png`} alt="Step 1" className="" />
        </div>
        <Paragraph>
            <>
        ...
        <div className="relative max-w-4xl mx-auto">
            <motion.img
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2 }}
                src={`/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.4.png`} alt="Step 2" className="absolute" />
            <motion.img
                initial={{ opacity: 0, x: 30 }}
                viewport={{ once: true }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.6 }}
                src={`/assets/ki-hajar-dewantara-sang-bapak-pendidikan-dan-sumbangan-pemikirannya-untuk-indonesia/5.4.1.png`} alt="Illustration 2" className="" />
        </div>
    </div>
}