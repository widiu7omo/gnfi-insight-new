...
export function CustomImageD() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        <div className="absolute bg-linear-to-b from-[#028d85] top-0 left-0 h-[30%] w-full" />
        <div className="mx-auto flex w-full flex-col items-center px-4 md:max-w-4xl md:flex-row md:items-start lg:px-0 relative z-10">
          <div className="w-full lg:w-2/3">
            ...
            <motion.img
              ...
              src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.1.png`}
              alt="Makan gratis"
      ...
      <div
        ...
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.2.png)` }}
      >
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-center space-x-0 px-4 md:flex-row md:space-x-12 md:px-0">
          <div className="relative flex h-[200px] w-full self-start md:h-[250px] md:w-1/2">
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.3.png`}
              alt="Makan gratis"
            ...
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.4.png`}
              alt="Makan gratis"
          ...
          <div className="flex w-full py-6 md:w-1/2 md:py-0">
            <motion.p
              ...
              transition={{ duration: 0.8, ease: "easeOut" }}
              viewport={{ once: true }}
              className="text-lg leading-normal font-medium text-[#FFB433] md:text-[28px]"
            >
      ...
      <div
        ...
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.5.jpg)` }}
      >
        <div className="mx-auto px-4 md:max-w-4xl lg:px-0 relative z-10">
          <div className="flex w-full flex-col items-center space-x-0 md:flex-row md:space-x-4 lg:space-x-8">
            <div className="flex h-full w-full grow flex-col pb-20 md:pb-0 lg:w-4/5">
              <motion.h3
                initial={{ opacity: 0, scale: 0.9, y: 10 }}
                whileInView={{ opacity: 1, scale: 1, y: 0 }}
                transition={{ duration: 0.4, ease: "easeOut" }}
              ...
              >
                {SKANDAL.map((item, index) => (
                  ...
                  >
                    <div className="mt-2 h-3 w-3 shrink-0 rounded-full bg-[#009990] align-baseline" />
            ...
            <div className="h-full w-full md:w-2/5">
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/4.6.png`}
                alt="Makan gratis"
        ...
        <div className="absolute bg-linear-to-t from-white bottom-0 left-0 h-[30%] w-full z-0" />
      </div>
    </div>
  );
}
