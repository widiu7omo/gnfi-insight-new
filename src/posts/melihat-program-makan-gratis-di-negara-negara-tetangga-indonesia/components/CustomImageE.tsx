...
export function CustomImageE() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        className="relative flex h-full w-full flex-col justify-center bg-cover bg-no-repeat pb-20 pt-16 text-center md:pb-0 md:pt-20"
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.1.jpg)` }}
      >
        <div className="absolute bg-linear-to-b from-[#eaeaec] top-0 left-0 h-[30%] w-full" />
        ...
        <div className="relative mx-auto w-full px-4 md:max-w-4xl lg:px-0">
          ...
          <div className="flex flex-col gap-y-8 md:flex-row md:gap-x-8">
            <div className="w-full md:w-1/2">
              <div className="flex w-1/2 items-center pl-[5%]">
                <div className="relative">
                  <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-white md:h-28 md:w-28">
                    <motion.img
                      ...
                      src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.2.png`}
                      alt="Bendera Kamboja"
                ...
                <div className="z-10 -ml-12 flex min-w-55 justify-center rounded-full bg-[#003092] py-2 md:min-w-62.5 md:py-4">
                  <motion.p
              ...
              <div className="relative -mt-10 h-255 w-full rounded-3xl bg-[#B8CFFE] px-4 pt-16 md:-mt-14 md:h-300 md:px-6 md:pt-20">
                <motion.div
                  className="space-y-8"
                  initial="hidden"
                  whileInView="visible"
                ...
                >
                  {KAMBOJA.map((item, index) => (
                    ...
                    >
                      <div className="mt-2 h-3 w-3 shrink-0 rounded-full bg-[#003092] align-baseline" />
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "backOut" }}
                  src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.5.png`}
                  alt="Anak Makan"
            ...
            <div className="w-full md:w-1/2">
              <div className="flex w-1/2 items-center pl-[5%]">
                <div className="relative">
                  <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-white md:h-28 md:w-28">
                    <motion.img
                      ...
                      whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                      transition={{ duration: 0.8, ease: "backOut" }}
                      src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.3.png`}
                      alt="Bendera Laos"
                      className="z-20 h-full w-full rounded-full object-cover"
                    />
                  </div>
                ...
                <div className="z-10 -ml-12 flex min-w-55 justify-center rounded-full bg-[#008E86] py-2 md:min-w-62.5 md:py-4">
                  <motion.p
                    initial={{ opacity: 0, x: -50 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
              ...
              <div className="relative -mt-10 h-225 w-full rounded-3xl bg-[#8EDFE4] px-4 pb-20 pt-16 md:-mt-14 md:h-300 md:px-6 md:pt-20">
                <motion.div
                  className="space-y-8"
                  initial="hidden"
                  whileInView="visible"
                ...
                >
                  {LAOS.map((item, index) => (
                    <motion.div
                      ...
                      className="flex space-x-2"
                    >
                      <div className="mt-2 h-3 w-3 shrink-0 rounded-full bg-[#008E86] align-baseline" />
                      <p className="text-left font-sora text-xl text-[#2A3335] md:text-2xl">
                        {item}
                      </p>
                    </motion.div>
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "backOut" }}
                  src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.4.png`}
                  alt="Anak Makan"
          ...
          <motion.img
            ...
            src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/5.5.png`}
            alt="Anak Makan"
            className="absolute left-0 z-10 z-20 hidden max-w-4xl bottom-0 md:block md:max-h-75 md:w-auto lg:max-h-87.5"
          />
          <img
            src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/footer.png`}
            className="relative z-50 mx-auto hidden w-full sm:block bottom-0 invert"
          />

        </div>
        <div className="absolute bg-linear-to-t from-[#eaeaec] bottom-0 left-0 h-[30%] w-full" />
      </div>
    </div>
  );
}
