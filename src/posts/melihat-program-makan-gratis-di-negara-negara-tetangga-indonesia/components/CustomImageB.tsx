  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden ">
      <div
        ...
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/2.0.jpg)` }}
      >
        <div className="absolute w-full h-[50%] bg-linear-to-b from-[#51534d] top-0" />
        <div className="z-10 w-full">
          <div className="max-w-4xl mx-auto relative space-y-2 inset-x-0 z-10 mb-4 text-center font-sora text-3xl font-bold text-white md:text-6xl flex flex-col justify-center items-center">
            <motion.h3
              ...
              className="px-4 py-2 rounded-xl wrap-break-word w-fit">
            ...
            <div className="basis-1/3">
              <motion.div
                ...
                <motion.img
                  ...
                  src={"/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/2.1.png"} alt="Plate" className="absolute -top-8 -right-8 w-40 z-10" />

                <div className="space-y-4 text-left">
                  <h6 className="pb-1 text-2xl font-semibold mr-16">Rancangan
                    Makanan
                    Tambahan
                    (RMT)</h6>
                  <p className="text-lg">
              ...
              <motion.div
                ...
                <motion.img
                  ...
                  src={"/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/2.2.png"} alt="Plate" className="absolute -top-8 right-0 w-40 z-10" />
                <div className="text-lg text-left relative z-10">
                  <div>Penerima:</div>
                  <div className="mr-20 pb-1.5">Siswa yang
                    memenuhi
                    salah satu dari
          ...
          <div className="bg-[#272727] h-full w-full -mt-5 pt-20 font-sora relative">
            <div className="absolute top-0 sm:-top-16 lg:-top-40 left-0 -right-8 w-full">
              <motion.img
                viewport={{ once: true }}
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ delay: 0, duration: 0.6 }}
                src={'/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/2.4.png'} className="object-contain w-full scale-[2] md:scale-100" alt="Flag" />
            </div>
            <div className="flex max-w-4xl mx-auto w-full flex-col lg:flex-row relative z-10 bg-[#272727]">
              <div className="basis-1/2 flex flex-col p-8 items-start justify-start">
                ...
                <ul className="text-left text-white text-lg space-y-2">
                  <motion.li
                    ...
                    <div className="w-0 h-0 border-t-10 mt-1.5 scale-[0.80] border-t-transparent border-b-10 border-b-transparent border-l-20 border-l-yellow-500"></div>
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2, duration: 0.4 }}
                src={'/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/2.3.jpg'} alt="Children" className="basis-1/2 w-full lg:w-1/2" />
            </div>
            <img src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/footer.png`} className="z-50 hidden sm:block relative bottom-0 h-fit w-fit mx-auto" alt="Footer" />
          </div>
        </div>
      </div>
    </div>
