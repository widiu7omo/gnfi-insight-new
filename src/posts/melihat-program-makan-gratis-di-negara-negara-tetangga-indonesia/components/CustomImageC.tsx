  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.6.png)` }}
      >
        <div className="absolute bg-linear-to-b from-[#008882] top-0 left-0 h-[30%] w-full" />
        ...
        <div className="relative mx-auto flex w-full items-center px-4 md:max-w-4xl lg:px-0">
          <motion.img
            ...
            src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.1.png`}
            alt="Makan gratis"
            className="relative z-10 -mb-16 h-auto w-2/3 md:-mb-32 md:ml-8"
          />
      ...
      <div
        className="relative flex h-full w-full justify-center bg-cover bg-center py-28 text-center md:py-48"
        style={{ backgroundImage: `url(/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.2.png)` }}
      >
        <div className="z-10 mx-auto justify-center md:max-w-4xl">
          <div className="mx-auto flex w-full items-center justify-center space-x-4 md:max-w-2xl md:space-x-8 lg:space-x-12">
            <div className="relative h-112 w-1/2 justify-center rounded-xl bg-[#009990] px-4 pb-64 pt-28 text-center md:h-200 md:pb-80 md:pt-40">
              <div className="relative flex w-full justify-center">
                <motion.img
                  ...
                  whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "backOut" }}
                  src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.3.png`}
                  alt="Makan gratis"
                  className="absolute -top-40 z-50 h-auto w-2/3 md:-top-56"
                />
              </div>
              <motion.p
            ...
            <div className="relative h-112 w-1/2 justify-center rounded-xl bg-[#003092] px-4 pb-48 pt-28 text-center md:h-200 md:pb-80 md:pt-40">
              <div className="relative flex w-full justify-center">
                <motion.img
                  viewport={{ once: true }}
                  initial={{ opacity: 0, y: 50, scale: 0.8 }}
                  whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "backOut" }}
                  src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.4.png`}
                  alt="Makan gratis"
                  className="absolute -top-32 z-50 h-auto w-2/3 md:-top-52"
                />
              </div>
              <motion.p
                initial={{ opacity: 0, y: 30 }}
        ...
        <motion.img
          ...
          whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
          transition={{ duration: 0.8, ease: "backOut" }}
          src={`/assets/melihat-program-makan-gratis-di-negara-negara-tetangga-indonesia/3.5.png`}
          alt="Makan gratis"
