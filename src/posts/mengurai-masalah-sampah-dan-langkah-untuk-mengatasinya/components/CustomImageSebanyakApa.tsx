...
export function CustomImageSebanyakApa() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        className="relative flex h-full w-full justify-center bg-cover bg-center text-center py-12 md:py-32"
        style={{ backgroundImage: `url(/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.1.png)` }}
      >
        <div className="absolute w-full h-[50%] bg-linear-to-b from-[#D98452] top-0" />
        <div className="z-10 mx-auto">
          ...
          <div className="relative mx-auto flex w-full max-w-4xl">
            <motion.img
              ...
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.2.png`}
              alt="Sebanyak apa Sampah di Indonesia"
              className="z-5 h-screen w-full object-cover object-left md:-mt-8 md:px-0 lg:ml-[20%] lg:h-auto lg:w-[80%]"
            />
            <div className="absolute left-0 top-4 z-10 md:top-22">
              <motion.p
                viewport={{ once: true }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="absolute right-0 top-full mt-10 flex flex-col items-end justify-end px-4 md:mt-32 xl:px-24">
                ...
                <motion.img
                  ...
                  src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.3.png`}
                  alt="Sebanyak apa Sampah di Indonesia"
                ...
                <motion.p
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2, duration: 0.4 }}
                  className="inline-block w-[90%] max-w-full whitespace-normal wrap-break-word bg-[#D62E31] px-4 py-2 text-left font-sora text-base font-medium text-white md:w-[60%] md:px-6 md:py-4 md:text-xl md:font-semibold"
                >
        ...
        <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center space-y-4 xs:flex-row xs:space-x-8 xs:space-y-0">
          <div className="relative size-40 overflow-visible rounded-xl border border-white bg-[#A33F11]">
            ...
            <motion.img
              ...
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.4.svg`}
              alt="Sisa makanan"
          ...
          <div className="relative size-40 overflow-visible rounded-xl border border-white bg-[#A33F11]">
            ...
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.5.svg`}
              alt="plastik"
          ...
          <div className="relative size-40 overflow-visible rounded-xl border border-white bg-[#A33F11]">
            ...
            <motion.img
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
              transition={{ duration: 0.8, ease: "backOut" }}
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/2.6.svg`}
