    ...
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        ...
        <div className="h-full w-full md:bg-[#104A34] md:mt-0 md:py-0 lg:px-0 md:px-4 lg:px-0">
          <div className="overflow-hidden md:overflow-visible z-20 mx-auto flex flex-col space-y-8 md:max-w-4xl md:flex-row md:items-center md:space-x-8 md:space-y-0">
            <motion.img
              ...
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.1.png`}
              alt="Poster"
        ...
        <div className="z-20 my-4 flex flex-col items-center px-4 md:mx-auto md:max-w-4xl md:flex-row lg:px-0">
          <div className="my-8 w-full space-y-2 md:my-12 md:w-1/2 md:space-y-6">
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.2, duration: 0.4 }}
              className="px-4 text-left font-sora text-lg md:px-0 md:text-2xl text-black"
            >
            ...
            <div className="my-24 flex aspect-square w-[80%] items-center justify-center rounded-full bg-[#D6D63A] md:my-0 md:w-full">
              <div className="absolute top-0 z-20 mx-auto flex flex-col items-center justify-center md:-top-36">
                <motion.img
                  ...
                  src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.2.png`}
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.4, ease: "easeOut" }}
                  src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.3.png`}
                  alt="Dokumentasi kegiatan"
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, ease: "easeOut" }}
                src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.7.png`}
                alt="Sampah"
          ...
          <div className="relative z-20 mx-auto flex flex-col md:max-w-4xl md:flex-row">
            <div className="relative w-full md:w-[55%]">
              <motion.img
                ...
                src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.5.png`}
              ...
              <motion.img
                ...
                src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.6.png`}
                alt="Pengolahan sampah"
        ...
        <div
          ...
          style={{ backgroundImage: `url(/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.8.png)` }}
        >
          <div className="absolute z-0 w-full h-[50%] bg-linear-to-t from-[#001c0f] bottom-0" />
          <div className="z-30 relative mx-auto flex w-full max-w-full flex-col px-4 md:max-w-4xl md:flex-row md:px-0">
            ...
            <motion.img
              ...
              src={`/assets/mengurai-masalah-sampah-dan-langkah-untuk-mengatasinya/4.9.png`}
              alt="Foto bersama"
