    ...
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        <div className="flex justify-center">
          <img
            src={`/assets/manis-bisnis-es-krim-di-indonesia/5.1.png`}
            alt="Hero Image"
        ...
        <div className="z-10 relative mx-auto max-w-4xl items-center px-4 lg:px-0">
          ...
          <motion.div
            className="ml-auto items-center bg-[#C50007] py-2 lg:py-4 md:w-[50%] rounded-4xl lg:rounded-[3rem]"
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.8, ease: "backOut" }}
          >
            <p className="text-base text-white lg:text-3xl p-4 lg:p-8 pb-20 lg:pb-38">
          ...
          <div className="ml-auto items-center md:w-[50%]">
            <motion.div
              className="bg-white p-4 lg:p-8 text-black rounded-3xl lg:rounded-[3rem] -top-14 relative text-[1.5rem] lg:text-6xl font-extrabold text-[#C50007] lg:-top-32 lg:p-12 lg:text-[5rem] lg:text-[4rem] font-bold"
      ...
      <div className="relative -mt-20 lg:-mt-44 w-full bg-[#F0E4E8] rounded-t-[7rem] px-4 pt-12 md:pt-10 lg:pt-24">
        <div className="mx-auto max-w-4xl flex text-black text-left font-sora text-lg md:text-2xl space-y-0 md:space-y-12">
          <motion.img
            ...
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/manis-bisnis-es-krim-di-indonesia/5.2.png`}
            alt="Es Krim"
            className="relative z-10 object-contain lg:h-auto w-1/3 md:w-2/5 pr-8 -ml-4 lg:-ml-8 mt-0 md:-mt-40 lg:-mt-80"
          />
          <motion.p className="relative -top-[5%] md:-top-16 lg:-top-24 md:ml-10 pt-4 md:pt-10 text-base md:text-xl md:text-2xl"
