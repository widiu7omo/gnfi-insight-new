  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/manis-bisnis-es-krim-di-indonesia/4.1.png)` }}
      >
          ...
          <div className="z-1 relative mx-auto max-w-4xl md:px-12 px-4 space-y-16 md:space-y-32 pt-1 md:pt-12">
            <div className="flex w-full flex-row text-center">
              <motion.div
                ...
                viewport={{ once: true }}
                className="ml-20 relative w-full flex flex-col justify-center text-left text-white bg-[#E35AA7] rounded-3xl pl-14 md:pl-88 pr-6 md:pr-14 py-8 md:py-12"
              >
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                <motion.img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/4.2.png`}
                  alt="Overlay"
                  initial={{ scale: 0, rotate: -15, opacity: 0 }}
                  whileInView={{ scale: 1, rotate: 0, opacity: 1 }}
                  transition={{ duration: 0.6, ease: "backOut", delay: 0.3 }}
                  viewport={{ once: true }}
                  className="absolute -bottom-12 -left-24 md:-left-40 w-48 h-48 md:h-136 md:w-136 object-contain"
                />
              </motion.div>
            </div>
            <div className="flex w-full flex-row text-center">
              <motion.div
                ...
                transition={{ duration: 0.8, ease: "easeOut", delay: 0.2 }}
                viewport={{ once: true }}
                className="mr-20 relative w-full flex flex-col justify-center text-left text-white bg-[#E35AA7] rounded-3xl pr-12 md:pr-88 pl-6 md:pl-14 py-8 md:py-12"
              >
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                <motion.img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/4.3.png`}
                  alt="Overlay"
                  initial={{ scale: 0, rotate: -15, opacity: 0 }}
                  whileInView={{ scale: 1, rotate: 0, opacity: 1 }}
                  transition={{ duration: 0.6, ease: "backOut", delay: 0.3 }}
                  viewport={{ once: true }}
                  className="absolute -bottom-12 -right-24 md:-right-40 w-48 h-48 md:h-136 md:w-136 object-contain"
                />
              </motion.div>
            </div>
          </div>
