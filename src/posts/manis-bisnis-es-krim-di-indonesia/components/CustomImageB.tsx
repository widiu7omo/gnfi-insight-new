...
export function CustomImageB() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        className="relative w-full justify-center bg-cover bg-bottom pb-12 pt-16 md:pb-32 md:pt-24 xl:pb-24"
        style={{ backgroundImage: `url(/assets/manis-bisnis-es-krim-di-indonesia/2.1.1.png)` }}
      >
        <div className="absolute left-0 top-0 h-[30%] w-full bg-linear-to-b from-[#B52874]" />
        <div className="space-y-14 md:space-y-24">
          <div className="z-1 relative mx-auto max-w-4xl md:px-0 px-4 ">
            <div className="flex w-full flex-col md:flex-row text-center items-stretch  bg-[#FE98D9] lg:rounded-t-3xl lg:rounded-b-3xl rounded-t-3xl rounded-b-none">
              ...
              >
                <img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.3.png`}
                  alt="Ragusa"
              ...
              >
                ...
                <motion.img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.2.png`}
                  alt="Overlay"
                  initial={{ scale: 0, rotate: -15, opacity: 0 }}
                  whileInView={{ scale: 1, rotate: 0, opacity: 1 }}
                  transition={{ duration: 0.8, ease: "backOut", delay: 0.3 }}
                  viewport={{ once: true }}
                  className="absolute -top-16 md:-top-24 -right-6 w-40 h-40 md:h-56 md:w-56 object-contain"
                />
              </motion.div>
            </div>
          ...
          <div className="z-1 relative mx-auto max-w-4xl md:px-12 px-4">
            <div className="flex w-full flex-col md:flex-row-reverse text-center items-stretch">
              ...
              >
                <img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.4.png`}
                  alt="Zangrandi"
              ...
              >
                ...
                <motion.img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.8.png`}
                  alt="Overlay"
                  initial={{ scale: 0, rotate: 10, opacity: 0 }}
                  whileInView={{ scale: 1, rotate: 0, opacity: 1 }}
                  transition={{ duration: 0.8, ease: "backOut", delay: 0.3 }}
                  viewport={{ once: true }}
                  className="absolute -top-16 md:-top-24 -right-12 w-40 h-40 md:h-56 md:w-56 object-contain"
                />
              </motion.div>
            </div>
            <Paragraph>
          ...
          <div className="z-1 relative mx-auto max-w-4xl md:px-12 px-4">
            ...
            >
              ...
              >
                <img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.5.png`}
                  alt="Baltic"
          ...
          <div className="z-1 relative mx-auto max-w-4xl md:px-12 px-4">
            ...
            >
              ...
              >
                <img
                  src={`/assets/manis-bisnis-es-krim-di-indonesia/2.6.png`}
                  alt="Tjanang"
      ...
      <div className="bg-[#0013FF] w-full pt-20 pb-6 md:py-24 relative">
        <div className="z-1 relative mx-auto max-w-4xl md:px-12 px-4">
          ...
          >
            ...
            >
              <img
                src={`/assets/manis-bisnis-es-krim-di-indonesia/2.7.png`}
                alt="Oen"
                className="h-96 w-full rounded-3xl md:w-full md:h-full object-cover"
              />
            </motion.div>
