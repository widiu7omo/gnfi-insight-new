    ...
    const renderImages = () => {
        ...
        for (let i = 5; i < 20; i++) {
            images.push(<motion.img key={`${i}`}
                ...
                className="absolute"
                src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.${i}.png`} alt={`Milk Comp ${i}`} />)
        }
        return images;
    }
    return <section id="section-1" className="bg-[#fff6e9] -mt-1 overflow-clip ">
        <div className="flex flex-col h-[300px] items-center justify-center bg-cover bg-center">
            <h2 className="max-w-5xl px-4 sm:px-0 text-center text-3xl font-bold leading-snug lg:text-4xl xl:text-5xl relative">
                ...
                <motion.img
                    src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/milk2.svg`} alt="Milk 2" className="absolute -left-80 size-160 -bottom-108" />
                <motion.img
                    src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/milk.svg`} alt="Milk" className="absolute -right-32 size-80 -bottom-32" />
            </h2>
        </div>
        <div className="mb-16">
            <Paragraph>
        ...
        <div className="relative flex items-start justify-center overflow-clip">
            <div className="w-full bg-cover bg-no-repeat bg-position-[center_top_-8rem]" style={{ backgroundImage: `url(/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.1.png)` }}>
                <div className="absolute z-0 bg-linear-to-b top-0 bottom-[10%] left-0 right-0 from-[#fff6e9] to-black/0" />
                <div className="absolute z-0 bg-linear-to-t top-[35%] bottom-0 left-0 right-0 from-white to-black/0" />
                <div className="max-w-4xl pb-16 mx-auto relative z-10">
                    <motion.img
                        ...
                        src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.2.png`} alt="Susu" />
                    <motion.img
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        transition={{ delay: 0.3 }}
                        src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.3.png`} alt="Manfaat Susu" />
                    <div className="space-y-0">
                        <div className="relative flex items-center justify-center">
                            <motion.img
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                transition={{ delay: 0.3 }}
                                src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.4.png`} alt="Nutrition" />
                            {renderImages()}
                        </div>
                    </div>
                    <motion.img
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.3 }}
                        src={`/assets/hikayat-segelas-susu-dari-minuman-bergizi-hingga-jadi-komoditas-politik/1.20.png`} alt="Manfaat Susu" />
                    <Paragraph>
                        <>
