...
const DATA = [
  {
    img: `/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.2.png`,
    desc: "Disajikan di Konferensi Asia Afrika (KAA) 1995",
  },
  {
    img: `/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.3.png`,
    desc: "Dipromosikan lewat program Indonesia Spice Up the World (ISUTW)",
  },
  {
    img: `/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.4.png`,
    desc: "Penjualnya ada di sejumlah kota besar dunia, mulai dari London hingga Amsterdam",
  },
  {
    img: `/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.5.png`,
    desc: 'Soto Betawi masuk "10 Makanan Berkuah Terbaik di Dunia" versi TasteAtlas',
  },
  {
    img: `/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.6.png`,
      ...
      >
        <div className="absolute left-0 right-0 top-0 z-10 flex justify-center">
          <motion.img
            ...
            src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.1.png`}
            alt="Soto Background"
          ...
          <div className="mb-4 space-y-4 md:mb-8 lg:mt-28">
            <div className="relative flex w-full rounded-xl bg-[#2F2F2F] py-4 md:pr-[10%]">
              <motion.img
                ...
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.7.png`}
                alt="Sarah Carter"
              ...
              <div className="relative ml-[30%] flex h-full flex-col justify-center lg:ml-[40%]">
                ...
                <motion.img
                  ...
                  whileInView={{ opacity: 1, x: 0, scale: 1.1 }}
                  transition={{ duration: 0.8, ease: "backOut" }}
                  src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.8.png`}
                  alt="Tanda Petik"
          ...
          <div className="mb-4 space-y-4 md:mb-8 lg:mt-16">
            <div className="relative flex w-full rounded-xl bg-[#2F2F2F] py-4 md:pr-[10%]">
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, x: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/5.9.png`}
                alt="Ryo Matsumara"
