  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.1.png)` }}
      >
        <div className="absolute left-0 top-0 h-[30%] w-full bg-linear-to-b from-[#272727]" />
        <div className="z-1 relative mx-auto max-w-4xl items-center px-4 lg:px-0">
          ...
          <motion.img
            ...
            src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.2.png`}
            alt="Soto"
          ...
          <div className="mx-auto mt-[30%] flex w-full max-w-4xl flex-col items-center justify-center space-y-14 xs:mt-4 xs:flex-row xs:space-x-4 xs:space-y-0 sm:space-x-10 md:space-x-16">
            <div className="relative size-36 overflow-visible rounded-xl bg-[#E3E3E3] xs:size-48">
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.3.png`}
                alt="Notes"
            ...
            <div className="relative size-36 overflow-visible rounded-xl bg-[#E3E3E3] xs:size-48">
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.4.png`}
                alt="Soto"
            ...
            <div className="relative size-36 overflow-visible rounded-xl bg-[#E3E3E3] xs:size-48">
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.5.png`}
                alt="Bendera"
      ...
      <div className="relative flex w-full flex-col justify-center bg-[#0a0000] bg-cover bg-center px-0 text-center md:flex-row">
        <div className="relative w-full md:w-1/2">
          <motion.img
            ...
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.6.png`}
            alt="Soto"
            className="h-40 w-full object-cover md:h-56 lg:h-80"
          />
          <div className="absolute bottom-0 left-0 h-[30%] w-full bg-linear-to-t from-[#0A0000] md:hidden" />
        </div>
        <div className="relative w-full md:w-1/2">
          <motion.img
            viewport={{ once: true }}
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "backOut" }}
            src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/3.7.png`}
            alt="Peta Indonesia"
            className="h-40 w-full object-cover md:h-56 lg:h-80"
          />
          <motion.div
