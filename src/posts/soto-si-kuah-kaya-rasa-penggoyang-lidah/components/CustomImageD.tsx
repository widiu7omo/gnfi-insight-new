  ...
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: `url(/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/4.5.png)` }}
      >
        <div className="absolute left-0 right-0 top-0 z-10 flex justify-center">
          <motion.img
            ...
            src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/4.1.png`}
            alt="Yellow Background"
            className="min-h-80 w-full object-cover md:h-full lg:max-h-[80%] lg:w-auto"
          />
        </div>
          ...
          <div className="flex flex-row">
            <div className="z-30 w-1/2">
              ...
              <motion.p
                ...
                transition={{ duration: 0.4, ease: "easeOut" }}
                viewport={{ once: true }}
                className="inline bg-white box-decoration-clone box-decoration-clone px-2 text-left font-sora text-lg text-[#2F2F2F] md:text-2xl md:leading-10 lg:text-3xl lg:leading-12"
              >
            ...
            <motion.img
              ...
              src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/4.2.png`}
              alt="Soto"
          ...
          <div className="md:hidden">
            <div className="flex items-end justify-center">
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/4.3.png`}
                alt="Yusril Fahriza"
          ...
          <div className="hidden md:block">
            <div className="mx-auto flex flex-row items-end">
              ...
              <div className="flex w-[80%] flex-col">
                ...
                <div className="-mb-5 -ml-[15%] flex items-center rounded-4xl bg-[#2F2F2F] py-2 pl-[18%] pr-2 md:py-4 md:pl-[20%] md:pr-8">
                  <motion.p
                    initial={{ opacity: 0, scale: 0.9, x: 30 }}
                    whileInView={{ opacity: 1, scale: 1, x: 0 }}
                    transition={{ duration: 0.4, ease: "easeOut" }}
                    viewport={{ once: true }}
                    className="font-sera text-base text-white md:text-xl md:leading-8 lg:text-2xl lg:leading-10"
                  >
                    Menunjukkan rasa cintanya terhadap soto lewat akun instagram{" "}
          ...
          <div className="mb-14 mt-8 md:hidden">
            <div className="flex items-end justify-center">
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, y: 0, scale: 1.1 }}
                transition={{ duration: 0.8, ease: "backOut" }}
                src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/4.4.png`}
                alt="Mees Hilgers"
                className="z-30 h-auto w-[40%]"
              />
            </div>
          ...
          <div className="mb-32 mt-48 hidden md:block">
            <div className="mx-auto -mt-32 flex flex-row items-end">
              <div className="-mr-[15%] flex w-[90%] flex-col">
                ...
                <div className="-mb-[4.5%] flex items-center rounded-4xl bg-[#2F2F2F] py-2 pl-2 pr-[18%] md:py-4 md:pl-8 md:pr-[18%] lg:pr-[16%]">
                  <motion.p
                    initial={{ opacity: 0, scale: 0.9, x: -30 }}
                    whileInView={{ opacity: 1, scale: 1, x: 0 }}
                    transition={{ duration: 0.4, ease: "easeOut" }}
      ...
      <div className="absolute bottom-0 z-50 mx-auto max-w-4xl">
        <img
          src={`/assets/soto-si-kuah-kaya-rasa-penggoyang-lidah/footer.png`}
          className="z-50 mx-auto hidden w-full invert sm:block"
        />
      </div>
      <div className="absolute left-0 h-[50%] w-full bottom-0 bg-linear-to-t from-[#d8d8d9]" />
    </div>
  );
}
