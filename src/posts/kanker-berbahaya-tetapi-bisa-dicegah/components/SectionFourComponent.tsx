    ...
    <>
      ...
      >
        <motion.img
          ...
          viewport={{ once: true }}
          src={`/assets/kanker-berbahaya-tetapi-bisa-dicegah/3.3.png`} />
        <motion.img
          initial={{ y: 20, opacity: 0 }}
          transition={{ delay: 0.3 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          src={`/assets/kanker-berbahaya-tetapi-bisa-dicegah/3.4.png`} />
        <motion.img
          initial={{ y: 20, opacity: 0 }}
          transition={{ delay: 0.3 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          src={`/assets/kanker-berbahaya-tetapi-bisa-dicegah/3.5.png`} />
      </div>
    </>
  );
}
