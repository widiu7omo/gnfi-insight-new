      ...
      <div className="relative flex items-end justify-center max-w-4xl w-full mx-auto pt-28">
        <div
          ...
          <motion.div viewport={{ once: true }}
            ...
            className="rounded-full bg-[#8e1d2c] object-center size-200 md:size-240 mt-[20%] md:mt-0 w-full" />
        </div>
        <motion.img viewport={{ once: true }}
          initial={{ opacity: 0, y: -20, scale: 0.8 }}
          whileInView={{ opacity: 1, y: 0, scale: 1 }}
          transition={{ delay: 0, duration: .3 }}
          src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.1.png`}
          alt="Train Center"
        ...
        <motion.img viewport={{ once: true }}
          ...
          src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.3.png`}
          alt="Train Right"
          className="absolute z-2 right-[-3%] md:-right-32 w-[70%] md:w-auto"
        />
        <motion.img viewport={{ once: true }}
          initial={{ opacity: 0, x: 40, scale: 0.9 }}
          whileInView={{ opacity: 1, x: 0, scale: 1 }}
          transition={{ delay: 0.4, duration: .3 }}
          src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.2.png`}
          alt="Train Left"
          className="absolute z-1 left-[-5%] md:-left-20 w-[90%] md:w-auto"
        />
      </div>
      <div className="block lg:hidden bg-[#8e1d2c] w-full">
        <div className="md:flex-row flex-col flex items-center">
          <motion.img viewport={{ once: true }}
            ...
            src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.6.png`}
            alt="Serupa, tapi Tak Sama"
            className="flex-1 relative z-10 h-full w-full object-contain max-h-200 -mt-24"
          />
          <motion.div viewport={{ once: true }}
            initial={{ opacity: 0, y: -20, scale: 0.8 }}
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            ...
            <div className="flex flex-col space-y-2">
              <div className="space-x-2 pl-12 pt-4 flex items-start">
                <div className="w-0 h-0 border-t-[1rem] border-t-[#8e1d2c] border-l-8 border-l-transparent border-r-8 border-r-transparent rotate-270 pt-4" />
        ...
        <div className="max-w-5xl flex flex-col mx-auto relative h-fit items-center">
          <div className="flex flex-row-reverse items-start justify-center">
            <motion.img viewport={{ once: true }}
              ...
              whileInView={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ delay: 0, duration: .5 }}
              src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.4.png`}
              alt="Serupa, tapi Tak Sama"
              className="relative z-10 max-w-full sm:max-w-[80%] top-0 sm:-top-8"
            />
            <motion.img viewport={{ once: true }}
              initial={{ opacity: 0, y: -20, scale: 0.8 }}
              whileInView={{ opacity: 1, y: 0, scale: 1 }}
              transition={{ delay: 0.3, duration: .2 }}
              src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.5.png`}
              alt="MRT"
          ...
          <motion.div viewport={{ once: true }}
            ...
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ delay: 0.2, duration: .3 }}
            className="bg-white pl-4 pt-4 p-4 sm:p-8 flex h-fit relative overflow-clip w-full -rotate-1 max-w-sm -mt-20 -ml-20 sm:-mt-12">
            <div className="flex flex-col space-y-2 absolute">
              {/* biome-ignore lint/suspicious/noArrayIndexKey: <explanation> */}
              {new Array(20).fill(0).map((i, inx) => (<div className="bg-[#8e1d2c] size-4" key={inx} />))}
            </div>
      ...
      <div className="relative z-10 bg-[#8e1d2c] w-full hidden lg:block">
        ...
        <div className="max-w-5xl flex mx-auto justify-between relative">
          <motion.img viewport={{ once: true }}
            ...
            src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.4.png`}
            alt="Serupa, tapi Tak Sama"
            className="relative z-10 max-w-[80%] -top-20"
          />
          <motion.div viewport={{ once: true }}
            initial={{ opacity: 0, y: -20, scale: 0.8 }}
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            transition={{ delay: 0.2, duration: .3 }}
            className="bg-white pl-4 pt-4 p-8 flex h-fit text-black overflow-clip w-full -rotate-1 max-w-sm absolute left-[30%]">
            <div className="flex flex-col space-y-2 absolute">
              {/* biome-ignore lint/suspicious/noArrayIndexKey: <explanation> */}
              {new Array(20).fill(0).map((i, inx) => (<div className="bg-[#8e1d2c] size-4" key={inx} />))}
            </div>
          ...
          <motion.img viewport={{ once: true }}
            ...
            src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/2.5.png`}
            alt="Serupa, tapi Tak Sama"
            className="relative z-10 max-w-[80%] -top-48"
          />
        </div>
      </div>
      <div className="bg-linear-to-t from-black/20 absolute bottom-0 left-0 right-0 h-full z-10" />
      <img src={`/assets/trem-mrt-lrt-transportasi-rel-masa-depan-indonesia/footer.png`} alt="Footer" className="lg:block hidden h-12 absolute bottom-0 z-10 w-full sm:h-20 object-cover object-bottom max-w-4xl mx-auto" />
    </div>
  );
}
