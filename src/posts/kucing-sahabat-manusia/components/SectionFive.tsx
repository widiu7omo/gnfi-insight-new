		...
		<section id="section-5" className="">
			<div className="relative bg-[#2d5e16] overflow-hidden">
				<div
					...
					style={{ backgroundImage: `url('/assets/kucing-sahabat-manusia/noise-paper2.jpeg')` }}
				/>
				...
				<div className="space-y-8 h-screen pt-16 flex-col ">
					<motion.h2
						...
						className={`relative z-40 mx-auto h-[60px] max-w-3xl text-center text-2xl font-bold leading-snug text-[#FAD30D] lg:text-3xl xl:text-5xl`}
					>
				...
				<div className="space-y-8 py-24 flex-col relative bg-[#35472D]/60">
					<motion.h3
						...
						whileInView={{ opacity: 1, y: 0 }}
						transition={{ delay: 0.3 }}
						className={`relative z-40 mx-auto max-w-full px-4 md:px-0 xl:max-w-3xl text-center font-medium leading-snug text-white text-xl xl:text-2xl`}
					>
