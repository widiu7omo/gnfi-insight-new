...
import Ornament1 from "./Ornament4a";
import Ornament2 from "./Ornament4b";
		...
		<section id="section-4" className=" overflow-hidden">
			<div className="space-y-8 flex item-center pb-24 flex-col bg-[#435348] relative">
				...
				<div className="relative top-0 py-4 xl:py-[8rem]">
					<motion.h2
						...
						className={`relative z-40 px-4 md:px-0 mx-auto max-w-full xl:max-w-3xl text-center text-3xl! lg:!text-5xl xl:!text-6xl font-bold leading-snug text-[#FAD30D]`}
					>
						<Ornament1 />
						<span className="relative">Hewan Penuh Mitos</span>
					</motion.h2>
					<Paragraph
						className={`z-40 text-white relative font-medium`}
					><>
						<Ornament2 />
						<p>
			...
			<div className="relative bg-[#D49C0B] ">
				<div
					...
					style={{ backgroundImage: `url('/assets/kucing-sahabat-manusia/noise-wall.jpeg')` }}
				/>
				<Rectangle />
				<WhiteCat />
				<Paragraph
					className={`z-20 py-12 relative font-medium`}
				><>
					<p>
