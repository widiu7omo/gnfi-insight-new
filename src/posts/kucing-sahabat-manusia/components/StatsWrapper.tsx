...
import StatsCat from "./StatsCat";
import StatsDog from "./StatsDog";
import StatsParrot from "./StatsParrot";
		...
		<div className="bg-[#E5E7E4]">
			<div className="relative overflow-hidden xl:overflow-visible">
				...
				<div className="mx-auto z-0 w-full flex items-center justify-center pb-[8rem]">
					<img
						src={`/assets/kucing-sahabat-manusia/sofa.png`}
						alt="Sofa"
					...
					<motion.img
						...
						src={`/assets/kucing-sahabat-manusia/stats-parrot.png`}
						alt="Parrot"
					...
					<motion.img
						...
						src={`/assets/kucing-sahabat-manusia/stats-dog.png`}
						alt="Dog"
					...
					<motion.img
						...
						src={`/assets/kucing-sahabat-manusia/stats-cat.png`}
						alt="Cat"
					...
					<div className="absolute max-w-7xl z-10 bottom-[2rem] xl:bottom-[8rem]">
						<img
							src={`/assets/kucing-sahabat-manusia/animal-group-1.png`}
							alt="Animals Group 1"
							className="w-full"
						/>
						<img
							src={`/assets/kucing-sahabat-manusia/animal-group-2.png`}
							alt="Animals Group 2"
							className="w-full"
						/>
						<img
							src={`/assets/kucing-sahabat-manusia/animal-footer.png`}
