    ...
    <div className="mx-auto w-full overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            backgroundImage: `url(/assets/gemilang-dendang-dangdut/5.0.png)`,
        ...
        >
          <div className="absolute inset-0 flex flex-col items-center justify-between overflow-y-auto p-4 text-white">
            <motion.div
              className="mx-auto flex max-w-4xl grow flex-col items-center justify-center space-y-6 md:space-y-8 lg:space-y-10"
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              >
                ...
                <div className="space-y-4 bg-purple-700 p-4">
                  ...
                  <motion.img
                    src={`/assets/gemilang-dendang-dangdut/5.1.png`}
                    alt="Album cover"
                    className="w-full"
            ...
            <motion.img
              ...
              src={`/assets/gemilang-dendang-dangdut/footer.png`}
              alt="footer"
              className="mt-8 w-full max-w-4xl relative z-10"
            />
            <div className="absolute bottom-0 w-full bg-linear-to-b from-[#512b19]/0 to-[#402213] h-[90px]" />
          </div>
          <motion.img
            src={`/assets/gemilang-dendang-dangdut/5.2.png`}
            alt="TV"
