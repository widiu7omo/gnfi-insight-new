...
export function CustomImageKontesDangdut() {
  return (
    <section id="section-1" className="bg-linear-to-b from-[#989da1] -mt-1 overflow-clip pb-16">
      <div className="relative flex items-start justify-center overflow-clip flex-col">
        <div className="max-w-4xl mx-auto relative">
          <img src={`/assets/gemilang-dendang-dangdut/4.0.png`} alt="Artist Dangdut Show" />
          <motion.img
            initial={{ opacity: 0, y: -20 }} viewport={{ once: true }}
            whileInView={{ opacity: 1, y: 0 }} transition={{ duration: .7, delay: 0.2 }}
            src={`/assets/gemilang-dendang-dangdut/4.1.png`} alt="Copy Kontent Dangdut" className="absolute bottom-[45%]" />
        ...
        <div className="max-w-4xl mx-auto relative space-y-8">
          <div className="flex flex-col xs:flex-row">
            ...
            >
              <img src={`/assets/gemilang-dendang-dangdut/4.2.png`} alt="KDI" />
              <div>
            ...
            >
              <img src={`/assets/gemilang-dendang-dangdut/4.3.png`} alt="KDI" />
              <div>
                <p className="text-center font-semibold text-[#9955a5] text-2xl xl:text-3xl">Kontes Dangdut Indonesia</p>
                <p className="text-center text-base xl:text-xl tracking-wide text-gray-600">MNC TV (2004 - Sekarang)</p>
              </div>
          ...
          <div className="flex flex-col xs:flex-row">
            ...
            >
              <img src={`/assets/gemilang-dendang-dangdut/4.4.png`} alt="KDI" />
              <div>
                <p className="text-center font-semibold text-[#9955a5] text-2xl xl:text-3xl">Kontes Dangdut Indonesia</p>
                <p className="text-center text-base xl:text-xl tracking-wide text-gray-600">MNC TV (2004 - Sekarang)</p>
              </div>
            ...
            <motion.div
              ...
              <img src={`/assets/gemilang-dendang-dangdut/4.5.png`} alt="KDI" />
              <div>
                <p className="text-center font-semibold text-[#9955a5] text-2xl xl:text-3xl">Kontes Dangdut Indonesia</p>
                <p className="text-center text-base xl:text-xl tracking-wide text-gray-600">MNC TV (2004 - Sekarang)</p>
              </div>
