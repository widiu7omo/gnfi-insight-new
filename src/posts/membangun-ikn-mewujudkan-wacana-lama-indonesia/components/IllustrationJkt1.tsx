...
export default function Illustration1() {
  return (
    <div className={"relative flex h-[700px] items-start justify-center bg-cover bg-[50%_70%]"} style={{ backgroundImage: `url('/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/da84d88dc706e90c8b1d715b4ee601bf.webp')` }}>
      ...
      <div className="relative bottom-0 left-0 right-0 top-0 z-40 flex h-[400px] w-full max-w-full flex-col items-center  justify-center md:max-w-3xl">
        ...
        >
          <motion.div
            ...
            viewport={{ once: true }}
            className="skew-y-3 text-center md:text-left text-black"
          >
            Kota yang Pernah <br />
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="absolute bottom-0 z-10 h-[500px] w-full max-w-xl bg-gray-300 text-neutral-950 px-12 pt-16 text-xl xl:w-fit xl:pt-24 xl:text-3xl"
      >
        <span className=''>Memindah ibu kota Indonesia</span>
        <br />
      ...
      <div className="absolute bottom-0 left-0 z-[10] overflow-hidden">
        <motion.img
          ...
          src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/monas.png`}
          alt="Monas"
      ...
      <div className="absolute bottom-0 z-20 flex w-full flex-col items-center justify-center">
        <motion.img
          ...
          src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/soldier.png`}
          alt="Monas"
