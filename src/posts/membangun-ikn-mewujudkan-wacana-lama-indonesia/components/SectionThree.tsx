import Ornament1 from './Ornament3a'
import Ornament2 from './Ornament3b'
import Quote from './Quote3a'
import Ornament5 from './Ornament3e'
import Ornament4 from './Ornament3d'
import Ornament3 from './Ornament3c'
  ...
  return (
    <section id="section-3" className="relative">
      ...
      <Header
        ...
        coverImage={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/cover-section3.webp`}
        className="relative"
      />
        ...
        <Paragraph className="relative">
          <>
            ...
            <div className="relative flex flex-col items-center space-x-2 xl:flex-row xl:items-end">
              <p className="grow text-lg font-bold text-neutral-950">
              ...
              <div className="relative w-[165px] flex-none">
                <img
                  src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/jj.png`}
                  alt="JJ Rizal"
