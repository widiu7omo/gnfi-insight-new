...
import Ornament1 from './Ornament2a'
import Ornament2 from './Ornament2b'
import Ornament3 from './Ornament2c'
import Quote from './Quote2a'
import Ornament5 from './Ornament2e'
import Ornament6 from './Ornament2f'
...
export default function SectionTwo() {
  return (
    <section
      id="section-2"
      className="bg-linear-to-b from-[#312C18] to-[#B4B0AD]"
    >
      <div className="space-y-8 py-16 xl:py-36">
        <motion.h2
          ...
          className={`relative mx-auto max-w-2xl text-center text-2xl font-bold leading-snug text-white lg:text-3xl xl:text-5xl`}
        >
        ...
        <div className="relative mx-auto px-4  xl:max-w-7xl xl:px-0">
          <motion.img
            ...
            src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/e42f5d290b3f0cf65ba5d712a3a4ae41.jpeg`}
        ...
        <Paragraph
          className={`pt-9 text-white relative font-normal`}
        ><>
            <p>
        ...
        <Quote />
        <Paragraph className={`text-white relative font-normal`}>
          <>
            <p>
