...
import Ornament1 from './Ornament7a'
import Ornament2 from './Ornament7b'
import Ornament3 from './Ornament7c'
  ...
  return (
    <section id="section-7">
      <Header
        ...
        coverImage={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/cover-section7.jpeg`}
      />
      ...
      <div className="relative flex items-start justify-center bg-[#E5E5E5] py-8">
        <div className="flex max-w-4xl flex-col-reverse space-x-0 px-4 xl:flex-row xl:space-x-4 xl:px-0">
          <img
            src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/bambang.png`}
            alt="Bambang Brojonegoro"
            className="w-[175px] flex-none object-contain"
          />
          <div className="relative">
            <p className="relative z-10 flex-grow text-black text-lg font-bold">
