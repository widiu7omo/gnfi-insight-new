...
import Card from './CardJokowi'
import Ornament1 from './Ornament8a'
import Ornament2 from './Ornament8b'
import Ornament3 from './Ornament8c'
import Ornament4 from './Ornament8d'
import Quote from './Quote8a'
  ...
  return (
    <section id="section-8">
      <Header
        ...
        coverImage={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/cover-section9.jpeg`}
      />
