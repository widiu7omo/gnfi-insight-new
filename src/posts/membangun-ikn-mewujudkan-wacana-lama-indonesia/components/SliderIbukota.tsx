"use client";
import { type PanInfo, motion, useMotionValue } from "motion/react";
import { type PropsWithChildren, useRef, useState } from "react";
const generateSlide = () => {
  return [
    {
      image: `/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/sukarno-square.png`,
      title: "Palangkaraya",
      desc: "Wacana pada era Orde Lama saat Palangkaraya dibangun pada 1957",
    },
    {
      image: `/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/suharto-square.png`,
      title: "Jonggol",
      desc: "Ingin dikembangkan sebagai kota mandiri, namun tak terwujud hingga Orde Baru tumbang pada Mei 1988",
    },
    {
      image: `/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/sby-square.png`,
      title: "Jawa Barat",
