import Ornament4 from './Ornament2d'
  ...
  return (
    <div className="relative mx-auto w-full max-w-[75ch] rounded-br-none bg-stone-800 pt-4 sm:rounded-full sm:pt-0">
      ...
      <div className="inline-flex h-48 flex-col items-end justify-end space-x-4 sm:flex-row sm:items-center">
        <div
          className={`pl-4 text-[18px] font-bold leading-7 text-white sm:pl-[90px] relative`}
        >
        ...
        <img
          ...
          src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/990bcf9dceabed1a2ff85967cae2d172.png`}
        />
      </div>
    </div>
  )
