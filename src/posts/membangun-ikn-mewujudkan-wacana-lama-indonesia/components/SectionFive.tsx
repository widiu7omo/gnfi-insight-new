...
import Quote from './Quote5a'
import IndoMap from './IndoMap'
import Ornament3 from './Ornament5c'
import SliderIbukota from './SliderIbukota'
  ...
  return (
    <section id="section-5">
      <Header
        ...
        coverImage={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/cover-section5.jpeg`}
      />
      ...
      <div className="relative bg-[#FC9803] pt-8">
        <div
          style={{ background: `url(/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/noise.png)` }}
        ...
        <div className="relative my-8 bg-[#3C3C3B]">
          <Paragraph className="w-full py-12">
            <p className="px-8 text-center text-lg font-bold leading-snug text-white xl:text-3xl">
