  ...
  return (
    <div className="flex items-center justify-center pt-8">
      <div className="flex max-w-[65ch] flex-col items-center xl:flex-row">
        <img
          src={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/jokowi.png`}
          alt="Joko Widodo"
          className="w-[187px] flex-none"
        />
        <div className="flex grow flex-col items-center justify-start space-y-4 px-0 py-4 xl:px-8 xl:py-0">
