import Ornament1 from './Ornament6a'
import Ornament2 from './Ornament6b'
import FaktaIkn from './fakta-ikn'
import Ornament3 from './Ornament6c'
import Ornament4 from './Ornament6d'
...
export default function SectionSix() {
  return (
    <section id="section-6">
      <Header
        coverImage={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/cover-section6.webp`}
        customTitle={
      ...
      <div className="bg-[#374B1E] py-8">
        <Paragraph className="py-0 text-white xl:py-12">
          <>
            <Ornament1 />
            <Ornament2 />
            <p>
