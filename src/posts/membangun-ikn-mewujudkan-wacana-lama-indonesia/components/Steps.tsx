...
export default function Steps() {
  ...
  return (
    ...
    >
      <StepItem
        withRightOrnament
        imageSource={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/yogya.png`}
        title={'Yogyakarta'}
        desc={'Januari 1946-Desember 1949'}
      />
      <StepItem
        imageSource={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/bukittinggi.png`}
        title={'Bukittinggi'}
        desc={
      ...
      <StepItem
        withLeftOrnament
        imageSource={`/assets/membangun-ikn-mewujudkan-wacana-lama-indonesia/bireuen.png`}
        title={'Bireuen'}
        desc={
