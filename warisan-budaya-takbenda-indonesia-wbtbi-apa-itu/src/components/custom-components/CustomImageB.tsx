  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={fadeInLeft}
        className="absolute size-[60rem] blur-[10rem] bottom-[20rem] bg-gradient-to-b to-[40%] from-purple-600 to-pink-600 rounded-full right-20"
      />
      <motion.div
        initial="hidden"
        animate={heroInView ? "visible" : "hidden"}
        variants={fadeInLeft}
        className="absolute size-[50rem] blur-[8rem] bottom-[20rem] bg-red-600 rounded-full right-20"
      />
      <motion.div
        initial="hidden"
        animate={heroInView ? "visible" : "hidden"}
        variants={fadeInLeft}
        className="absolute size-[40rem] blur-[4rem] bottom-[20rem]  bg-gradient-to-b from-red-600 to-yellow-600 rounded-full right-[20rem]"
      />
