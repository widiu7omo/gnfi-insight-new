...
export function CustomImageA() {
  return (
    <div className="relative overflow-clip font-sora py-14 bg-no-repeat bg-cover" style={{ backgroundImage: `url(${baseUrl}/assets/1.0.jpg)`, backgroundColor: 'black' }}>
      ...
      <div className="max-w-4xl mx-auto relative z-10 pt-0 lg:pt-[6rem] pb-20">
        ...
        <div className="relative">
          <motion.img
            ...
            viewport={{ once: true }}
            src={`${baseUrl}/assets/1.1.png`} alt="Player 1" className="relative z-10 -ml-[10%] sm:-ml-[20%]" />
          <motion.img
            initial={{ opacity: 0, y: 80 }} whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: .4, delay: .5 }}
            viewport={{ once: true }}
            src={`${baseUrl}/assets/1.2.png`} alt="Player 2" className="absolute top-0 right-[-10%] hidden sm:block" />
          <div className="relative z-10 flex sm:flex-row flex-col sm:space-x-6 -mt-[35%] font-sora">
            <motion.div
              ...
              <div className="space-y-4 w-full">
                <img src={`${baseUrl}/assets/1.3.png`} className="object-contain object-center mx-auto px-8 h-[200px] sm:h-[250px]" alt="Yard 1" />
                <div className="h-[200px] sm:h-[320px] w-full flex flex-col ">
                  ...
                  <div className="flex items-end justify-end relative w-full h-[180px]">
                    <img src={`${baseUrl}/assets/1.4.png`} alt="Padel Racket" className="absolute w-[37%] xl:w-auto bottom-[-4%] left-[-15%]" />
            ...
            <motion.img
              ...
              transition={{ duration: .4, delay: .5 }}
              viewport={{ once: true }}
              src={`${baseUrl}/assets/1.2.png`} alt="Player 2" className="block mt-[10%] sm:mt-0 sm:hidden" />
            <motion.div
              initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }}
              ...
              <div className="space-y-4 w-full">
                <img src={`${baseUrl}/assets/1.5.png`} className="object-contain px-8 h-[200px] object-center mx-auto sm:h-[250px]" alt="Yard 2" />
                <div className="h-[200px] sm:h-[320px] w-full flex flex-col ">
                  <div className="mx-auto pb-6 sm:pb-0 px-8 flex-1 h-full">
                    <p className="text-lg sm:text-2xl max-w-xs text-left">Ukuran lapangannya</p>
                  ...
                  <div className="relative w-full h-[180px] rounded-b-2xl bg-[#e4e3ff]">
                    <img src={`${baseUrl}/assets/1.6.png`} alt="Padel Racket" className="absolute bottom-[-4%] w-[60%] sm:w-[68%] xl:w-auto right-[-20%]" />
          ...
          <div className="relative mt-10 flex sm:flex-row flex-col items-end justify-end w-full">
            <div className="relative z-10 ">
              <motion.img
                ...
                viewport={{ once: true }}
                src={`${baseUrl}/assets/1.7.png`} alt="Tenis Player" className="relative sm:w-auto w-[70%] z-10" />
              <motion.div
              ...
              <motion.div
                ...
                <img src={`${baseUrl}/assets/1.9.png`} alt="Ball" className="absolute left-[-5%] top-[-5%]" />
            ...
            <div className="sm:absolute left-0 bottom-0 font-sora mt-[20%] z-0">
              <div className="relative">
                <motion.img
                  ...
                  viewport={{ once: true }}
                  src={`${baseUrl}/assets/1.8.png`} alt="Padel Player" className="z-10 relative" />
                <motion.div
                  initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }}
                  transition={{ duration: .6, delay: .5 }}
                  viewport={{ once: true }}
