...
export function CustomImageE() {
  const jamu = [
    {
      title: "Sido Muncul",
      image: `${baseUrl}/assets/5.11.png`,
    },
    {
      title: "Jamu Jago",
      image: `${baseUrl}/assets/5.10.png`,
    },
    {
      title: "Air Mancur",
      image: `${baseUrl}/assets/5.9.png`,
    },
    {
      title: "Mustika Ratu",
      image: `${baseUrl}/assets/5.8.png`,
    },
    {
      title: "Jamu Iboe",
      image: `${baseUrl}/assets/5.7.png`,
    },
    {
      title: "Rahsa Nusantara",
      image: `${baseUrl}/assets/5.6.png`,
    },
  ]
  return (
    <div className="relative flex flex-col items-center overflow-hidden">
      ...
      >
        <img src={`${baseUrl}/assets/5.1.png`} alt="Ornamen Top" className="absolute top-0 right-0" />
        <img src={`${baseUrl}/assets/5.4.png`} alt="Leaves" className="absolute bottom-0 w-full right-0" />
        <img src={`${baseUrl}/assets/5.5.png`} alt="Jamu right" className="absolute bottom-0 w-fit right-0" />
        <img src={`${baseUrl}/assets/5.0.png`} alt="Jamu left" className="absolute bottom-0 w-fit left-0" />
