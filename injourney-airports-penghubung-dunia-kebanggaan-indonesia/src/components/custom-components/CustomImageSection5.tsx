...
export function CustomImageSection5() {
  return (
    <div className="relative flex flex-col items-center overflow-hidden bg-cover font-sora">
        ...
        <div className="absolute bottom-0 z-10 flex justify-start w-full transform pb-4">
          <div className="flex flex-col items-start w-full px-4 mx-auto space-y-4 md:max-w-4xl md:space-y-8 md:px-10">
            <motion.p
              ...
              whileInView={{ opacity: 1, x: 0, y: 0 }}
              transition={{ delay: 0.3, duration: 0.4 }}
              className="max-w-[80%] text-left text-xl font-sora font-extrabold text-[#131313] md:max-w-[50%] md:pt-6 md:text-6xl"
            >
            ...
            <motion.p
              ...
              whileInView={{ opacity: 1, x: 0, y: 0 }}
              transition={{ delay: 0.3, duration: 0.4 }}
              className="mt-2 max-w-[90%] text-left text-base font-sora font-semibold text-[#131313] md:max-w-lg md:text-2xl"
            >
        ...
        <div className="relative flex justify-between w-full px-4 mx-auto md:max-w-4xl md:space-x-4 md:px-10">
          <div className="relative z-40 w-1/2 my-auto text-white space-y-4 md:mb-48 md:max-w-md">
            <div className="text-base font-semibold leading-relaxed text-left md:text-lg">
              <img src={`${baseUrl}/assets/quote.png`} alt="Quote Start" className="size-8 absolute top-[-2%] left-[-10%]" />
              ...
              internasional.
              <img src={`${baseUrl}/assets/quote.png`} alt="Quote End" className="size-8 rotate-180 absolute bottom-[40%] right-[-10%]" />
            </div>
            <div className="mt-12 bg-[#0c9fad] px-4 py-4 -ml-4">
              <p className="text-base font-semibold text-white md:text-xl md:font-bold">
        ...
        <div className="inset-0 z-30 flex items-center justify-center px-4 pb-[10rem]">
          <div className="flex flex-col w-full space-y-12 md:max-w-4xl md:px-10 lg:space-y-[4rem]">
            <motion.p
              ...
              whileInView={{ opacity: 1, x: 0, y: 0 }}
              transition={{ delay: 0.3, duration: 0.4 }}
              className="w-full text-xl font-semibold text-center text-white md:mt-4 md:text-3xl md:font-bold "
            >
      ...
      <img src={`${baseUrl}/assets/footer.png`} alt="Footer" className="max-w-7xl mx-auto absolute bottom-0 z-20" />
    </div>
  );
}
