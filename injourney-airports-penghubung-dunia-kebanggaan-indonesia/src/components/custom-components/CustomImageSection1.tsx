        ...
        <div className="flex flex-col items-center justify-end h-[25rem] max-w-7xl mx-auto relative pb-8">
          <div className="flex flex-col items-center space-y-4 ">
            <motion.img viewport={{ once: true }}
              ...
              src={`${baseUrl}/assets/1.1.png`} alt="In Journey" className="w-fit" />
            <motion.div viewport={{ once: true }}
              initial={{ opacity: 0, y: -20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: .8, ease: "easeInOut", delay: 0.5 }}
              className="font-sora text-3xl xl:text-5xl font-semibold text-center !leading-snug">
                ...
                <div className="flex-grow">
                  ...
                  <div className="px-4 py-6 text-white xl:py-12 xl:px-12 space-y-6">
                    ...
                    <motion.img viewport={{ once: true }}
                      ...
                      src={`${baseUrl}/assets/1.7.png`} alt="Dots" />
                    <motion.div viewport={{ once: true }}
                      initial={{ opacity: 0, x: 20 }}
                      whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="relative flex flex-col-reverse items-center w-full mx-auto lg:flex-row max-w-7xl">
            <div className="relative flex-1">
              ...
              <motion.img
                ...
                viewport={{ once: true }}
                src={`${baseUrl}/assets/1.4.png`} alt="Dony Oskaria" className="relative max-w-[80%] start-8" />
            </div>
