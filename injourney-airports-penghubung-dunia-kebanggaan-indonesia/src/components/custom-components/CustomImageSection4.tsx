        ...
        <div className="top-0 h-full max-w-4xl mx-auto z-30 sm:pb-[20rem]">
          <div className="flex flex-col sm:flex-row justify-center w-full sm:space-x-8 space-y-[10rem] xs:space-y-8 sm:space-y-0 ">
            <motion.div
              ...
              className="w-full flex-1 bg-gradient-to-t from-[#10a7b5] to-[#0f6e78] px-4 md:px-8 py-4 md:py-8 h-fit mx-4 sm:mx-0 rounded-b-3xl xs:max-w-[70%] xs:ml-auto ml-0 max-w-full sm:ml-0 sm:max-w-full">
              <motion.p
                viewport={{ once: true }}
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
