...
export default function Navbar() {
  ...
  return (
    <motion.div
      ...
      className="data-[blur=true]:bg-white/60 data-[blur=true]:backdrop-blur-md data-[blur=true]:shadow sticky data-[blur=true]:h-[60px] lg:data-[blur=true]:h-[90px] h-[150px] top-0 bg-transparent z-50 px-6 lg:px-8 flex flex-col items-center justify-center"
    >
