...
export function CustomImageMerebutHati() {
  ...
  return (
    <section className="relative flex flex-col items-center overflow-hidden bg-cover">
      <motion.div
        className="w-full bg-gradient-to-b from-white via-[#8a201d] via-[#d6615a] via-[#ffffff] via-50% via-70% to-[#3b1312] pt-8"
        initial="hidden"
        whileInView="visible"
        variants={fadeInUp}
        viewport={{ once: true }}
      >
        <motion.div
          ...
          variants={fadeInUp}
        >
          <div className="relative w-full bg-[cover,contain] bg-[center_top] bg-no-repeat bg-blend-multiply xl:bg-[cover,auto]">
            <motion.p
            ...
            <div className="flex flex-row">
              <motion.div className="space-y-2 sm:space-y-8" variants={fadeInUp}>
                ...
                <div>
                  ...
                  <div className="mt-0 inline-block rounded-br-3xl bg-[#DF3E27] py-[2px] pl-[2px] pr-3 sm:mt-1 sm:py-1 sm:pl-1 sm:pr-4">
