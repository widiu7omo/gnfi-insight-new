    ...
    <section className="relative flex flex-col items-center overflow-hidden bg-cover">
      ...
      >
        <div className="mx-auto flex max-w-4xl flex-col items-start px-4">
          <motion.p
            className="pt-8 text-left text-lg font-bold leading-5 text-[#EBBF42] sm:text-4xl sm:leading-[3rem]"
            variants={simpleFadeIn}
          >
      ...
      >
        <div className="mx-auto flex max-w-4xl flex-col items-start px-4">
          ...
          <div className="relative mt-[-1.5rem] sm:mt-[-4rem]">
            <motion.img
