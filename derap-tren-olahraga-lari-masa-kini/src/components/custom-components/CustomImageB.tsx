      ...
      >
        ...
        <div className="z-10 max-w-4xl mx-auto">
          <motion.div
            ...
            className="relative space-y-2 inset-x-0 z-10 mb-4 text-center font-sora text-3xl font-bold text-white md:text-6xl flex flex-col justify-center items-center"
          >
            <h3 className="bg-[#9d2d3d] px-4 py-2 rounded-xl break-words w-fit">Lari, Olahraga Favorit</h3>
            <h3 className="bg-[#9d2d3d] px-4 py-2 rounded-xl break-words w-fit">Anak Muda Indonesia</h3>
          </motion.div>
          <div className="mt-[10rem] relative">
            <div className="absolute left-4 xl:left-0 top-0 space-y-4 z-10">
              <p className="text-2xl font-bold text-white px-4 !tracking-wide py-1 w-fit rounded-full bg-[#2643a3]">Hasil Survei</p>
              <img src={baseUrl + "/assets/2.2.png"} alt="2.2" className="" />
            </div>
            <div className="absolute lg:right-[-4rem] xl:right-[-13rem] top-[4rem] items-start flex-col z-10 lg:flex hidden">
              <div className="rounded-xl overflow-clip z-10 relative">
                <div className="bg-[#2643a3] px-6 pt-4 rounded-t-2xl lg:text-[12rem] xl:text-[14rem] tracking-normal leading-none font-bold text-white font-sora">
                  37
                </div>
                <div className="bg-[#9b2838] rounded-b-2xl text-white text-4xl py-2 ">persen milenial</div>
              </div>
            ...
            <div className="absolute lg:left-[-4rem] xl:left-[-6rem] top-[28rem] lg:flex hidden items-end flex-col z-10">
              ...
              <div className="rounded-xl overflow-clip z-10 relative">
                <div className="bg-[#5d25a3] px-6 pt-4 rounded-t-2xl lg:text-[12rem] xl:text-[14rem] tracking-normal leading-none font-bold text-white font-sora">
                  32
                </div>
                <div className="bg-[#9b2838] rounded-b-2xl text-white text-4xl py-2 ">persen gen Z</div>
              </div>
              <div className="pt-[3rem] w-full pl-10">
                <p className="text-white font-bold text-3xl tracking-wide text-start">Menggemari Lari</p>
              </div>
            </div>
            <img src={baseUrl + "/assets/2.1.png"} alt="People Run" className="w-full h-full object-contain relative z-[1]" />
          </div>
          <div className="absolute lg:hidden flex flex-col z-10 w-full left-0 divide-y divide-[#c2e4ff]">
            <div className="flex items-center w-full bg-[#9b2838]">
              <div className="w-[30%] py-4 text-3xl sm:text-5xl text-white font-bold bg-[#2643a3] px-6">37</div>
              <div className="flex-1 text-white text-3xl font-semibold text-left h-full pl-8">persen milenial</div>
            </div>
            <div className="flex items-center w-full bg-[#9b2838]">
              <div className="w-[30%] py-4 text-3xl sm:text-5xl text-white font-bold bg-[#2643a3] px-6">32</div>
              <div className="flex-1 text-white text-3xl font-semibold text-left h-full pl-8">persen gen Z</div>
            </div>
          ...
          <div className="relative z-10 mt-[16rem] xl:mt-[10rem] px-8 xl:px-0 space-y-4 xl:space-y-8">
            ...
            <p className="text-white font-medium text-center text-sm xl:text-2xl max-w-[80%] mx-auto">Jakpat dalam laporan "Indonesia Sports Habits and Healthy Lifestyle"</p>
