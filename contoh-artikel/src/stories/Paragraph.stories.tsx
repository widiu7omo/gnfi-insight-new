		...
		children: (
			<>
				<p>
					...
					banyak orang Indonesia Lainnya, manusia sudah memelihara kucing sejak
					ribuan tahun silam.
				</p>
				...
				<p>
					...
					moyang dari anjing dan beruang. Miacis ini kemudian mengalami evolusi
					menjadi kucing besar seperti singa dan harimau yang kemudian
				...
				<p>
					...
					Sungai Tigris dan Efrat. Masyarakat mengembangkan ikatan dengan kucing
				...
				<p>
					...
					Jean dari National Museum of Natural History in Paris melaporkan bahwa
					ditemukan bukti adanya kuburan manusia dan disampingnya terdapat
					kuburan kucing.
				</p>
				<p>
					“Fosil tersebut diperkirakan berumur 9.500 tahun. Hal ini
					mengungkapkan bahwa telah ada kedekatan antara manusia dan kucing
					sejak 10.000 tahun yang lalu,” tulis Dian Dwi Putri Ulan Sari Patongai
					dalam dalam Evolusi Kucing: Genetika dan Evolusi. Dalam tulisan
					tersebut, diuraikan pula bahwa ahli paleogenetik Claudio Ottoni
					membagi domestikasi kucing terjadi dalam dua jenis. Dia juga
...
export const WithOrnament: Story = {
	args: {
		className: "py-0 text-white xl:py-12 bg-black",
		children: (
			<>
				<Ornament className="top-0 right-[-2rem]">
					<svg
