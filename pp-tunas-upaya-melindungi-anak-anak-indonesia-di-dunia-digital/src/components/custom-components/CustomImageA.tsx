      ...
      <div className="max-w-4xl mx-auto font-sora">
        <div className="flex gap-2 flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex-1 space-y-2 px-4 md:px-0">
            ...
            <div className="text-lg sm:text-xl md:text-2xl font-medium">Pemerintah meluncurkan Peraturan Pemerintah (PP) Nomor 17 Tahun 2025 tentang Tata Kelola Penyelenggaraan Sistem Elektronik dalam Perlindungan Anak
              (PP Tunas)</div>
          </div>
        ...
        <div className="relative w-full overflow-hidden p-10">
          ...
          <div className="relative text-xl md:text-3xl text-center text-white py-6 px-4 font-bold">
            Bertujuan melindungi anak-anak dari ancaman <br />
            dan risiko bahaya di ruang digital
          </div>
        </div>
        <div className="space-y-8">
          <div className="text-center text-2xl md:text-4xl font-bold pt-6 md:pt-12">Hal-hal utama dalam PP Tunas:</div>
          <div className="flex flex-col md:flex-row gap-2 md:gap-5">
            <div className="flex-1">
              <div className="bg-white rounded-2xl shadow-lg px-10 md:px-12 py-8 m-4 md:m-0">
