  ...
  return (
    <section className="h-[1350px] sm:h-[2200px] relative">
      ...
      <div className="relative flex items-center justify-center w-full mx-auto">
        <motion.img initial={{ opacity: 0, y: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} src={`${baseUrl}/assets/kids.png`} alt="kids" className="absolute top-0 z-10" />
        <motion.img initial={{ opacity: 0, y: -20 }} viewport={{ once: false }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} src={`${baseUrl}/assets/background.png`} alt="background" className="absolute top-0" />
        <motion.img initial={{ opacity: 0, x: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 1.1 }} src={`${baseUrl}/assets/anak.png`} alt="anak" className="absolute top-0" />
        ...
        <motion.img initial={{ opacity: 0, y: 20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 }} src={`${baseUrl}/assets/description.png`} alt="description" className="absolute -top-6 z-10" />
        <motion.img initial={{ opacity: 0, x: -20 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 1 }} src={`${baseUrl}/assets/blood.png`} alt="blood" className="absolute top-0 z-20" />
      </div>
      <div className="flex items-center justify-center w-full mx-auto">
        <motion.img initial={{ opacity: 0, x: -30 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.1 }} src={`${baseUrl}/assets/doctor_bg.png`} alt="doctor_bg" className="absolute bottom-0" />
        <motion.img initial={{ opacity: 0, y: 30 }} viewport={{ once: false }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} src={`${baseUrl}/assets/doctor_quote.png`} alt="doctor_quote" className="absolute bottom-0" />
        <motion.img initial={{ opacity: 0, x: -30 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.3 }} src={`${baseUrl}/assets/quote_top.png`} alt="quote_top" className="absolute bottom-0" />
        <motion.img initial={{ opacity: 0, x: 30 }} viewport={{ once: false }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} src={`${baseUrl}/assets/quote_bottom.png`} alt="quote_bottom" className="absolute bottom-0" />
