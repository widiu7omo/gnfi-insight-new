		...
		<section id="section-3" className="bg-[#CFCFCF]">
			<div className="bg-[#EF9402] relative py-8 ">
				...
				<div className="relative pb-24 z-30">
					<h2 className="max-w-3xl mx-auto text-center text-3xl lg:text-5xl xl:text-6xl font-bold leading-snug text-white">
			...
			<div
				className={
					"flex h-[400px] xl:h-[800px] items-center justify-center bg-cover bg-[65%_50%] xl:bg-center"
				}
				style={{
					backgroundImage:
