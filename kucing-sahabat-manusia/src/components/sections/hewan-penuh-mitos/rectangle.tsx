...
export default function Rectangle() {
  return (
    <div className="bg-[#2C2C2C] p-12 max-w-4xl mx-auto relative -top-[7rem]">
      <CalicoCat />
      <Paragraph
      ...
      >
        ...
        <p>
          ...
          <i className={"text-[#FAD30D] font-bold"}>Serat Ngalamating Kucing</i>
          . Isinya adalah catatan mengenai hubungan antara warna kucing tertentu
